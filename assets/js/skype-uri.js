...
var Skype = new function () {
		...
		function l(L) {
			...
			uriPara.setAttribute("style", ("margin:0px"));
			...
			if (this.name === this.dropdownLinks.name) {
				...
				r.setAttribute("style", "display: none; position: absolute; margin-top: 0px; margin-left: 0px; width: 100px; padding-left: 5px; padding-right: 5px; border: 2px solid #00AFF0; background-color: white; color: #00AFF0; line-height: 30px; list-style: none; list-style-type: none;");
				...
				I.href = "javascript://";
				I.setAttribute("style", "text-decoration: none; color: #00AFF0; font-size: 14px;");
				...
				E.href = "javascript://";
				E.setAttribute("style", "text-decoration: none; color: #00AFF0; font-size: 14px;");
		...
		function j(u, r) {
			...
			this.dropdownLinks.linkImage = "http://idbuild.id.dyned.com/live/assets/icon/skype-icn.png";
