...
<div class="box b-f3-1">
	<div class="content padding15">
		...
		<h2>You Have No Sessions For Today</h2>
		<hr>
		
		<h3 class="padding15 b-fb-1">YOUR UPCOMING SESSIONS</h3>
                ...
                <table id="thetable" class="table-sessions"> 
                    <thead>
                        <tr>
                            ...
                            <th class="padding15 md-none">COACH</th>
                            <th class="padding15" style="width:50px !important"></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        foreach ($data as $d) {
                            ...
                            <tr>
                                ...
                                <td class="padding-10-15 md-none">
                                    <a href="<?php echo site_url('student/session/coach_detail/' . $d->coach_id); ?>" class="text-cl-secondary"><?php echo $d->coach_fullname ?></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
