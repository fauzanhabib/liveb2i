...
<?php if($module_extract){?>
    ...
    <div class="tabs-two tabs2 padding-t-20 padding-b-5 clearfix">
        ...
        <div id="tabs-content1" class="tabs-c clearfix">
            ...
            <div class="square-tabs bg-forthblue">
                 <h5 class="m-b-5 text-cl-white"><font size="4.5"><?php echo @$fe['pcfe1']; ?>%</font><br>
                    <?php echo @$fe['fe1']; ?></h5>
            </div>
            <?php }else{ } if(@$fe['fe2'] != null){ ?>
            <div class="square-tabs bg-forthblue">
                <h5 class="m-b-5 text-cl-white"><font size="4.5"><?php echo @$fe['pcfe2']; ?>%</font><br>
                    <?php echo @$fe['fe2']; ?></h5>
            </div>
        ...
        <div id="tabs-content3" class="tabs-c clearfix">
           ...
           <?php }else{ } if(@$efs['efs4'] != null){ ?>
            ...
            <div class="square-tabs bg-forthblue">
                <h5 class="m-b-5 text-cl-white"><font size="4.5"><?php echo @$efs['pcefs11']; ?>%</font><br>
                    <?php echo @$efs['efs11']; ?></h5>
            </div>
    ...
    <div id='tab1' class="pure-g clearfix w3-animate-opacity" style="height: 461.391px;">
    <div class="refresh">
