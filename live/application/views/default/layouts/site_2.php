                    ...
                    <div class="pure-menu">
                        <ul class="pure-menu-list">
                            <?php if ($this->auth_manager->role() == 'STD') { ?>
                                ...
                                <li class="pure-menu-item"><a href="<?php echo site_url('student/vrm'); ?>" class="pure-menu-link menu-dyned-pro">DynEd PRO</a></li>
                ...
                <header id="header">
                    <div class="pure-g large">
                        ...
                        <!--                        <div class="pure-u-1-24 setting-notification">
                                                    <div class="prelative">
                                                            <div class="notif"></div>
                        <?php // if (@$this->auth_manager->new_notification()['notification']) { ?>
                                                                <span class="label-notif"><?php //echo $this->auth_manager->new_notification()['notification'];  ?></span>
                        <?php //} ?>
                                                        </div></a>
                                                </div>-->
                        <div class="pure-u-1-24 setting-notification">
                        ...
                        <div class="pure-u-4-24 menu-left">
                            <div class="pure-menu">
                                <ul class="pure-menu-list">
                                    <?php if ($this->auth_manager->role() == 'STD') { ?>
                                        <li class="pure-menu-heading">Menu</li>
                                        <li class="pure-menu-item pure-menu-selected"><a href="<?php echo site_url('account/identity/detail/profile'); ?>" class="pure-menu-link menu-profile">Profile</a></li>
                                        <li class="pure-menu-item"><a href="<?php echo site_url('student/find_coaches/single_date'); ?>" class="pure-menu-link menu-book">Book A Coach</a></li>
                                    ...
                                    <?php } else if ($this->auth_manager->role() == 'CCH') { ?>
                                        <li class="pure-menu-heading">Menu</li>
                                        <li class="pure-menu-item pure-menu-selected"><a href="<?php echo site_url('account/identity/detail/profile'); ?>" class="pure-menu-link menu-profile">Profile</a></li>
                                        <li class="pure-menu-item"><a href="<?php echo site_url('coach/schedule'); ?>" class="pure-menu-link menu-shedule">Coach Shedule</a></li>
                                        <li class="pure-menu-item"><a href="#" class="pure-menu-link menu-student-list">Student List</a></li>
                                        <li class="pure-menu-item"><a href="#" class="pure-menu-link menu-progress-report">Student Progress Report</a></li>
                                        <li class="pure-menu-heading">OTHER APPS</li>
                                        <li class="pure-menu-item"><a href="#" class="pure-menu-link menu-skype">Skype</a></li>
...
//                            echo "<script type='text/javascript'>alert('$message');</script>";
        ...
        <script type="text/javascript">
            ...
            $('.setting-notification').click(function () {
                $(".dropdown-notif-box").toggle();
            });
