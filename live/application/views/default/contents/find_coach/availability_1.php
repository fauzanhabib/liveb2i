...
<table border="1">
    <tr>
        ...
        <tr>
            ...
            <td> <a href="<?php echo site_url('student/find_coaches/booking/'.$coach_id.'/'.$date.'/'.@$availability[$i]['start_time'].'/'.@$availability[$i]['end_time']); ?>" onclick="return confirm('Are you sure?');">Book</a> </td>
        </tr>
        <?php
            }
        ?>
