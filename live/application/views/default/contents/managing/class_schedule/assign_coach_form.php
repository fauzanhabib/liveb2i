                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="pure-button btn-small btn-white reschedule-session">
                                                                <span onclick="confirmation('<?php echo site_url('student_partner/managing/do_reschedule_session/' . @$class_id . '/' . @$class_meeting_id . '/' . @$d['coach_id'] . '/' . @date('Y-m-d', $date) . '/' . $av['start_time'] . '/' . $av['end_time']); ?>', 'group', 'Reschedule Session', 'manage-session', 'reschedule-session');">RESCHEDULE</span>
                                                            </a>
                                                        </td>
                                                        <?php }else{?>
                                                        <td>
                                                            <a class="set-session">
                                                                <span onclick="confirmation('<?php echo site_url('student_partner/managing/create_meeting_day/' . @$class_id . '/' . @$d['coach_id'] . '/' . @date('Y-m-d', $date) . '/' . $av['start_time'] . '/' . $av['end_time']); ?>', 'group', 'Add Session', 'manage-session', 'set-session');">SET SCHEDULE</span>
                                                            </a>
                                                        </td>
                                                        <?php }?>
                                                    </tr>
