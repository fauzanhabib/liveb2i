    ...
    <div class="heading pure-g padding-t-30">
        <div class="left-list-tabs pure-menu pure-menu-horizontal text-center margin0">
            <ul class="pure-menu-list">
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey active-tabs-blue" href="<?php echo site_url('partner/coach_upcoming_session/one_to_one_session/'.@$coach_id);?>">Upcoming Session</a></li>
                ...
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey" href="<?php echo site_url('partner/coach_histories/index/'.@$coach_id);?>" >Session Histories</a></li>
                <!-- <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey" href="<?php echo site_url('partner/coach_histories/class_session');?>" >Class Session Histories</a></li> -->
            </ul>
        </div>
    </div>
    ...
    <!-- <div class="content tab-content padding0">
        <div id="tab1" class="tab active"> -->
            ...
            <div class="margin0 padding15">
                ...
                <?php 
                echo form_open('partner/coach_upcoming_session/search/one_to_one/'.@$coach_id, 'class="pure-form filter-form" style="border:none"'); 
                ?>
                <div class="pure-g">
