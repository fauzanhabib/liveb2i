    ...
    <div class="breadcrumb-tabs pure-g">
        <div class="left-breadcrumb">
            <ul class="breadcrumb toolbar padding-l-0">
				...
				<li>
                    <form action="<?php echo site_url('partner/subgroup/index_disable');?>" method="POST" autocomplete="on" class="search-box">
...
<div class="box clear-both">
    ...
    <div class="heading heading-total-session pure-g prelative">
        <form class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24" action="<?php echo site_url('partner/subgroup/enable_subgroup');?>" method="POST">
        ...
        <div class="delete-add-btn padding-l-10 padding-t-65 pure-u-md-8-24 pure-u-lg-10-24">
            ...
            <button class="btn-noborder btn-normal bg-white-fff" type="submit" value="enable_subgroup" name="__submit" onclick="return confirm('Are you sure you want to enable?')"><a><img src="<?php echo base_url();?>assets/img/iconmonstr-x-mark-7-16.png" class="left padding-t-1 padding-r-5"><em class="textDec-none text-cl-red">Enable Group</em></a></button>
        </div>
    ...
    <div class="heading pure-g padding-t-30">
        <div class="left-list-tabs pure-menu pure-menu-horizontal text-center margin0">
            <ul class="pure-menu-list">
                <li class="pure-menu-item pure-menu-selected text-center no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey" href="<?php echo site_url('partner/subgroup/');?>">Active Groups</a></li>
                <li class="pure-menu-item pure-menu-selected text-center no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey active-tabs-blue" href="<?php echo site_url('partner/subgroup/index_disable/');?>" >Disabled Groups</a></li>
            </ul>
        </div>
    </div>
            ...
            <table id="large" class="display table-session tablesorter" cellspacing="0" width="100%">
                ...
                foreach ($data as $p) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $a; ?></td>
                        <td><a href="<?php echo site_url('partner/subgroup/list_disable_coach/'. $p->id); ?>" class="text-cl-tertiary"><u><?php echo $p->name?></u></a></td>
