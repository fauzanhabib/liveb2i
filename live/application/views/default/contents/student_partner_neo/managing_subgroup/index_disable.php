...
<div class="box clear-both">
    ...
    <div class="heading heading-total-session pure-g prelative">
        <form action="<?php echo site_url('student_partner_neo/subgroup/enable_subgroup');?>" method="POST" class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24">
        <div class="delete-add-btn padding-l-10 padding-t-65 pure-u-md-8-24 pure-u-lg-8-24">
            <!-- <div class="btn-noborder btn-normal bg-white-fff left"><a href="<?php echo site_url('student_partner_neo/subgroup/add_subgroup');?>"><img src="<?php echo base_url();?>assets/img/iconmonstr-plus-6-16.png" class="left padding-t-1 padding-r-5"><em class="textDec-none text-cl-tertiary">Add Group</em></a></div> -->
    ...
    <div class="heading pure-g padding-t-30">
        <div class="left-list-tabs pure-menu pure-menu-horizontal text-center margin0">
            <ul class="pure-menu-list">
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey" href="<?php echo site_url('student_partner_neo/subgroup/');?>">Active Groups</a></li>
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey active-tabs-blue" href="<?php echo site_url('student_partner_neo/subgroup/index_disable/');?>" >Disabled Groups</a></li>
            </ul>
        </div>
    </div>
    ...
    $no = 2;
                ...
                foreach ($data as $p) {
                    ...
                    <input type="checkbox" id="checkbox-1-<?php echo $no;?>" name="check_list[]" value="<?php echo $p->id;?>" class="regular-checkbox" /><label for="checkbox-1-<?php echo $no;?>"></label>
                        ...
                        <td><?php echo $a; ?></td>
                        <td><a href="<?php echo site_url('student_partner_neo/subgroup/list_disable_student/'. $p->id); ?>" class="text-cl-tertiary"><u><?php echo $p->name?><u></a></td>
