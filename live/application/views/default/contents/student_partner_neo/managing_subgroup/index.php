...
<div class="box clear-both">
    ...
    <div class="heading heading-total-session pure-g prelative">
        <form action="<?php echo site_url('student_partner_neo/subgroup/delete_subgroup');?>" method="POST" class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24">
    ...
    $no = 2;
                ...
                foreach ($data as $p) {
                    ...
                    <input type="checkbox" id="checkbox-1-<?php echo $no;?>" name="check_list[]" value="<?php echo $p->id;?>" class="regular-checkbox" /><label for="checkbox-1-<?php echo $no;?>"></label>
                        ...
                        <td><?php echo $a; ?></td>
                        <td><a href="<?php echo site_url('student_partner_neo/subgroup/list_student/'. $p->id); ?>" class="text-cl-tertiary"><u><?php echo $p->name?><u></a></td>
