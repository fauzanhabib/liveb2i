    ...
    <div class="breadcrumb-tabs pure-g">
        <div class="left-breadcrumb">
            <ul class="breadcrumb toolbar padding-l-0">
                ...
                <li><a href="<?php echo site_url('student_partner_neo/subgroup') ?>">Group</a></li>
    ...
    <div class="left-tabs pure-menu pure-menu-horizontal padding-t-17 padding-l-170">
        <ul class="pure-menu-list padding-t-18 right">
            <li class="pure-menu-item padding-tb-9 no-hover">
				...
				<a href="<?php echo site_url('student_partner_neo/subgroup') ?>" class="text-cl-tertiary">
...
<div class="box clear-both">
    ...
    <div class="heading heading-total-session pure-g prelative">
        <form class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24" action="<?php echo site_url('student_partner_neo/subgroup/delete_student/'.$this->uri->segment(4));?>" method="POST">
            ...
            <table id="large" class="display table-session tablesorter paginated" cellspacing="0" width="100%">
                ...
                foreach ($data2 as $d) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $a?></td>
                        <!-- <td><a href="<?php echo site_url('student_partner_neo/member_list/student_detail/'.$d->id.'/'.$subgroup_id);?>" class="text-cl-tertiary"><u><?php echo $d->fullname?></u></a></td> -->
