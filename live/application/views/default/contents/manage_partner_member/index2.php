...
<div class="box">
    <div class="heading pure-g">
        ...
        <div class="pure-u-1 edit no-left">
            <a href="<?php echo site_url('admin/manage_partner/add_partner_member'); ?>" class="add"><i class="icon icon-add"></i>Add Admin</a>
        </div>
        <!-- end block edit -->
    </div>
                    ...
                    <div class="grids list-people pure-u-1 pure-u-sm-12-24 pure-u-md-12-24 pure-u-lg-8-24 list">
                        ...
                        <div class="box-info">
                            ...
                            <div class="list-people-action text-center">
                                <a class="pure-button btn-small btn-transparent m-t-50 partner-member" onclick="confirmation('<?php echo site_url('admin/manage_partner/delete_partner_member/' . $user->id); ?>', 'group', 'Delete Partner Member', 'list-partner-member', 'partner-member');">DELETE
                                </a>
                            </div>
