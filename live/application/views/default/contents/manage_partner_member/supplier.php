                ...
                <div class="content" style="border-bottom:1px solid #f3f3f3">
                    <div class="pure-g">
                        <div class="pure-u-7-24 profile-image text-center divider-right">
                            ...
                            <?php if($type == "student") { ?>
                            <a href="<?php echo site_url('admin/manage_partner/add_token/'.$user->id.'/'.$partner_id);?>">
                            ...
                            <div class="more pure-u-1 width50perc padding-t-10 list-partner">
                                <a class="pure-button btn-red btn-small width100perc text-cl-white delete-partner" onclick="confirmation('<?php echo site_url('admin/manage_partner_admin/delete/'.@$type.'/'.@$user->id.'/'.@$partner_id); ?>', 'group', 'Delete Partner', 'list-partner', 'delete-partner');">
                                    DELETE
                                </a>
                            </div>
                            <?php } ?>
                        ...
                        <div class="pure-u-16-24 profile-detail prelative">
                            ...
                            <form action="<?php echo site_url("admin/manage_partner_admin/update/".@$type."/".@$partner->id."/".@$user->id); ?>" method="POST" id="form-admin" data-parsley-validate>
