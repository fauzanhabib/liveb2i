        ...
        <tbody>
            ...
            for ($i = 0; $i < count(@$availability); $i++) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo site_url('student_partner/schedule/summary_book/'.$search_by. '/' . $student_id .'/' . $coach_id . '/' . $date . '/' . @$availability[$i]['start_time'] . '/' . @$availability[$i]['end_time']); ?>" class="pure-button btn-small btn-white">Book</a>
                    </td>
                </tr>
                <?php
            }
