...
<div class="box clear-both">
    ...
    <div class="content padding-t-10">
        <div class="box">
            ...
            <form action="<?php echo site_url('student_aff_m/reporting/export_rpt');?>" method="POST" target="_blank">
            ...
            <table id="large" class="display table-session tablesorter" cellspacing="0" width="100%" style="overflow: auto;">
                ...
                foreach ($stu_rpt as $d) {
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;padding-left: 5px !important;"><a href="<?php echo site_url('student_aff_m/reporting/tokenhist/'.$d->user_id);?>" class="text-cl-tertiary" target="_blank"><?php echo $d->fullname; ?></a></td>
