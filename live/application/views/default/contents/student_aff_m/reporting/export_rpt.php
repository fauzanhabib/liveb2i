...
<table id="large" class="display tablesorter" cellspacing="0" width="100%">
    ...
    foreach ($stu_rpt as $d) {
        ...
        <tr>
            ...
            <td style="text-align: left;padding-left: 5px !important;"><a href="<?php echo site_url('student_aff_m/member_list/student_detail/'.$d->user_id);?>" class="text-cl-tertiary" target="_blank"><?php echo $d->fullname; ?></td>
