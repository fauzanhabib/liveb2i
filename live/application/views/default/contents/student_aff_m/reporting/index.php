    ...
    <div class="heading pure-g padding-t-30">
        <div class="left-list-tabs pure-menu pure-menu-horizontal text-center margin0">
            <ul class="pure-menu-list">
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey active-tabs-blue" href="<?php echo site_url('student_aff_m/add_token/index');?>">Add Token per Student</a></li>
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey" href="<?php echo site_url('student_aff_m/add_token/group_index');?>" >Add Token per Group</a></li>
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey" href="<?php echo site_url('student_aff_m/refund_token');?>" >Refund Token</a></li>
            </ul>
        </div>
    </div>
                    ...
                    <tr onclick="myFunction(this)">
                        ...
                        <td class="">
                            <div class="margin-auto">
                                <a href="<?php echo site_url('student_aff_m/member_list/student_detail/'.$d->id);?>" class="text-cl-tertiary"><u><?php echo $d->fullname?></u></a>
                            </div>
                        </td>
                        <td><?php echo $d->token_amount?></td>
                        <td>
                        <form name ="addtoken" action="<?php echo(site_url('student_aff_m/add_token/action_add_token'));?>" method="post" onsubmit="return confirm('This action can not be undo');">
