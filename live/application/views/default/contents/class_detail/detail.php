                                ...
                                for ($j = 0; $j < count(@$schedule[$w]); $j++) {
                                    ...
                                    <tr data-link="week-<?php echo $i + 1; ?>" class="tr week-<?php echo $i + 1;
                                        ...
                                        <?php if ($j == 0) { ?>
                                            ...
                                            <?php } 
                                        ?>
                                        <td class="padding15" data-label="COACH"><a href="" class="text-cl-secondary"><?php echo @$id_to_name[@($schedule[$w][$j]->coach_id)]; ?></a></td>
                                        <td class="padding15" data-label="TIME">
                                            <span class="text-cl-green"><?php echo(date('H:i', strtotime(@($schedule[$w][$j]->start_time)))); ?> - <?php echo(date('H:i', strtotime(@($schedule[$w][$j]->end_time)))); ?></span>
                                        </td>
                                    </tr>
                                    <?php
                                }
...
<div class="box">
    ...
    <div class="heading">
        ...
        <div class="pure-u-12-24 text-right" style="margin: 15px -10px;">
            <a href="<?php echo site_url('student/class_detail/member/'.$class_id);?>" class="pure-button btn-small btn-white availability">VIEW ALL</a>
        </div>
    </div>
