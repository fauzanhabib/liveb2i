<?php
echo form_open('partner_monitor/schedule/' . $form_action . '/' . @$student_id, 'role="form"');
...
<script type="text/javascript">
    function dropdown_on_change(id, param){
        if(document.getElementById(id).value === ''){
            window.location.href = "<?php echo base_url(); ?>index.php/partner_monitor/schedule";
        }else if(param === 'by_coach'){
            window.location.href = "<?php echo base_url(); ?>index.php/partner_monitor/schedule/by_coach/"+<?php echo @$student_id?>+"/"+document.getElementById(id).value;
        }else if(param === 'by_date'){
            window.location.href = "<?php echo base_url(); ?>index.php/partner_monitor/schedule/by_date/"+<?php echo @$student_id?>+"/"+document.getElementById('coach_id').value+"/"+document.getElementById(id).value;
        }
    }
</script>
