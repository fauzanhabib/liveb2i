...
<div class="box clear-both">
    ...
    <div class="heading heading-total-session pure-g prelative">
        <form class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24" action="<?php echo site_url('partner_monitor/subgroup/delete_subgroup');?>" method="POST">
    ...
    <div class="heading pure-g padding-t-30">
        <div class="left-list-tabs pure-menu pure-menu-horizontal text-center margin0">
            <ul class="pure-menu-list">
                <li class="pure-menu-item pure-menu-selected text-center no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey active-tabs-blue" href="<?php echo site_url('partner_monitor/subgroup/');?>">Active Groups</a></li>
                <li class="pure-menu-item pure-menu-selected text-center no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey" href="<?php echo site_url('partner_monitor/subgroup/index_disable/');?>" >Disabled Groups</a></li>
            </ul>
        </div>
    </div>
       ...
       <div class="box">
            <table id="large" class="display table-session tablesorter" cellspacing="0" width="100%">
                ...
                foreach ($data as $p) {
                    ...
                    <tr>
                        <td><?php echo $a; ?></td>
                        <td><a href="<?php echo site_url('partner_monitor/subgroup/list_coach/'. $p->id); ?>" class="text-cl-tertiary"><u><?php echo $p->name?></u></a></td>
