<div class="heading text-cl-primary padding-l-20">
    ...
    <div class="breadcrumb-tabs pure-g">
        <div class="left-breadcrumb">
            <ul class="breadcrumb toolbar padding-l-0">
                ...
                <li><a href="<?php echo site_url('partner_monitor/subgroup') ?>">Coach Partner</a></li>
    ...
    <h1 class="margin0">Coach Group Details</h1>
    ...
    <div class="left-tabs pure-menu pure-menu-horizontal padding-t-17 padding-l-170">
        <ul class="pure-menu-list padding-t-18 right">
            <li class="pure-menu-item padding-tb-9 no-hover">
                <a href="<?php echo site_url('partner_monitor/subgroup');?>">
...
<div class="box clear-both">
    ...
    <div class="heading heading-total-session pure-g prelative">
        <form class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24" action="<?php echo site_url('partner_monitor/subgroup/delete_coach/'.$this->uri->segment(4));?>" method="POST">
        <!-- <div class="delete-add-btn padding-l-10 padding-t-65 pure-u-md-8-24 pure-u-lg-10-24">
            <div class="btn-noborder btn-normal bg-white-fff left"><a href="<?php echo site_url('partner_monitor/subgroup/coach/'.@$subgroup_id ); ?>"><img src="<?php echo base_url();?>assets//img/iconmonstr-plus-6-16.png" class="left padding-t-1 padding-r-5"><em class="textDec-none text-cl-tertiary">Add Coach To Group</em></a></div>
            <button class="btn-noborder btn-normal bg-white-fff" name="_submit" type="submit" onclick="return confirm('Are you sure you want to delete?')"><a><img src="<?php echo base_url();?>assets/img/iconmonstr-x-mark-7-16.png" class="left padding-t-1 padding-r-5"><em class="textDec-none text-cl-red">Delete Coach From Group</em></a></button>
        </div> -->
            ...
            <ul class="text-cl-grey">
                <li class="pure-menu-item no-hover">
                    <div class="total-box border-1-ccc width125 height70">
                        ...
                        <div class="content-total text-center padding-t-10">
                            <span class="font-semi-bold font-26"><?php echo count(@$total_coach); ?></span>
                        </div>
                    </div>
                </li>
                ...
                <li class="pure-menu-item no-hover">
                    <div class="total-box border-1-ccc width125 height70">
                        ...
                        <div class="content-total text-center padding-t-10">
                            <span class="font-semi-bold font-26"><?php $sum=0; foreach (@$all_coachs as $d) { $sum += $d->token_amount; } ?><?php echo @$sum; ?></span>
                        </div>
                    </div>
                </li>
            ...
            <table id="large" class="display table-session tablesorter paginated" cellspacing="0" width="100%">
                ...
                foreach ($data2 as $d) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $a?></td>
                        <!-- <td><a href="<?php echo site_url('partner_monitor/subgroup/coach_detail/'.@$subgroup_id.'/'.$d->id);?>" class="status-disable bg-green text-cl-white"><?php echo $d->fullname?></a></td> -->
