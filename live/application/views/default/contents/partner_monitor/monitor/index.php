    ...
    <div class="box">
        <div class="content">
            <div class="box pure-g">
              <form name ="leaving" action="<?php echo(site_url('partner_monitor/monitor/add_monitor_acc/'));?>" method="post">
...
<script type="text/javascript">
  $('.mondis').click(function(){
      ...
      $.ajax({
         type:"POST",
         url:"<?php echo site_url('partner_monitor/monitor/dis_mon');?>",
         data: {'userid':userid},
   ...
   $('.monena').click(function(){
       ...
       $.ajax({
          type:"POST",
          url:"<?php echo site_url('partner_monitor/monitor/ena_mon');?>",
          data: {'userid':userid},
          success: function(data){
            location.reload();
          }
    ...
    $('.mondel').click(function(){
        ...
        $.ajax({
           type:"POST",
           url:"<?php echo site_url('partner_monitor/monitor/del_mon');?>",
           data: {'userid':userid},
           success: function(data){
             location.reload();
           }
