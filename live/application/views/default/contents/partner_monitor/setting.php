    ...
    <div class="breadcrumb-tabs pure-g">
        <div class="left-breadcrumb">
            <ul class="breadcrumb toolbar padding-l-0">
                ...
                <li><a href="<?php echo site_url('partner_monitor/subgroup') ?>">Group</a></li>
				<li><a href="<?php echo site_url('partner_monitor/subgroup/edit_subgroup/'. $data3[0]->id); ?>"><?php echo $data3[0]->name; ?></a></li>
    ...
    <h1 class="margin0">Group Specific Setting</h1>
        ...
        <div class="heading pure-g">
            <div class="pure-u-18-24">
                <h3 class="h3 font-normal padding15 text-cl-secondary" style="float:left"><a href="<?php echo site_url('partner_monitor/subgroup/edit_subgroup/'. $data3[0]->id); ?>">BASIC INFO</a> | 
                    Group Setting
                </h3> 
            </div>
...
<div class="box b-f3-2">
    ...
    <div class="content padding0">
        ...
        <div class="list-frm">
            <?php echo form_open_multipart('partner_monitor/'.$this->uri->segment(2).'/update_setting/'.$data[0]->user_id, 'id="form" role="form" class="pure-form pure-form-aligned padding15" data-parsley-validate'); ?>
            <div class="heading pure-g">
