...
<div class="box">
    <div class="heading pure-g">
        <div class="pure-u-1 tab-list tab-link">
            <ul>
                <li><a href="<?php echo site_url('partner_monitor/coach_upcoming_session/one_to_one_session');?>">One to One Session</a></li>
                <li class="current"><a class="active" href="<?php echo site_url('partner_monitor/coach_upcoming_session/class_session');?>" >Class Session</a></li>
                <li><a href="<?php echo site_url('partner_monitor/coach_histories');?>" >Session Histories</a></li>
                <li><a href="<?php echo site_url('partner_monitor/coach_histories/class_session');?>" >Class Session Histories</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="content tab-content padding0">
        <div id="tab1" class="tab active">
            ...
            <div class="tab-edited margin0 padding15">
                ...
                <?php 
                echo form_open('partner_monitor/coach_upcoming_session/search/class', 'class="pure-form filter-form" style="border:none"'); 
                ?>
                <div class="pure-g">
                    <div class="pure-u-1">
                ...
                <tbody>
                    ...
                    <tr class="list-session">
                        ...
                        <td class="padding15 ">
                            <div class="rw">
                                <div class="b-50">
                                    <a onclick="confirmation('<?php echo site_url('partner_monitor/managing/set_class_schedule/'.@$d->class_id.'/'.@$d->date.'/re/'.@$d->id);?>', 'group', 'Reschedule', 'list-session', 'rescheduled');" class="pure-button btn-medium btn-white rescheduled">Reschedule</a>
                                </div>    
                                <div class="b-50">
                                    <a onclick="confirmation('<?php echo site_url('partner_monitor/managing/cancel_session/'.@$d->class_id.'/'.@$d->id);?>', 'group', 'Cancel', 'list-session', 'cancel');" class="pure-button btn-medium btn-red cancel">Cancel</a>
                                </div>
                            </div>
                            <div class="b-100">        
                                <a href="<?php echo site_url('partner_monitor/vrm/multiple_student/'. @$d->class_id); ?>" class="pure-button btn-medium btn-white">Progress Report</a>
                            </div>
                        </td>
                    </tr>
