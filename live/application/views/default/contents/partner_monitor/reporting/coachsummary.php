...
<div class="box clear-both">
    ...
    <div class="content padding-t-10">
        <div class="box">
            ...
            <form action="<?php echo site_url('partner_monitor/reporting/export_summary');?>" method="POST" target="_blank">
            ...
            <table id="large" class="display table-session tablesorter" cellspacing="0" width="100%">
                ...
                foreach ($cch_sum as $d) {
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo site_url('partner_monitor/reporting/detail/'.$d->user_id);?>" class="text-cl-tertiary" target="_blank"><?php echo $d->fullname; ?></a></td>
