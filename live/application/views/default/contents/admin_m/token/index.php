    ...
    <div class="heading pure-g">
        ...
        <div class="left-list-tabs pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list m-l-20">
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin_m/token');?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5 active-tabs-blue">Request Token</a></li>
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin_m/token/history');?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Token Histories</a></li>
            </ul>
        </div>
    ...
    <div class="content">
                    ...
                    <?php if ($data) { ?>
                        <td>
                            <div class="pure-button btn-red btn-small">
                                <a href="<?php echo site_url("admin_m/token/cancel/"); ?>"> Cancel Request </a>
                            </div>
                        </td>
        ...
        <div class="remodal" data-remodal-id="modal" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
            ...
            <div class="padding-t-12">
                <?php echo form_open('admin_m/token/create', 'role="form" class="text-center text-cl-grey" data-parsley-validate');?> 
