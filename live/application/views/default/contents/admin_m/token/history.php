<div class="heading text-cl-primary padding-l-20">
    ...
    <div class="heading text-cl-primary padding-l-20">
        ...
        <h1 class="margin0 left">Token Histories</h1>
...
<div class="box clear-both">
    ...
    <div class="heading pure-g">
        ...
        <div class="left-list-tabs pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list m-l-20">
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin_m/token');?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Request Token</a></li>
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin_m/token/history');?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5 active-tabs-blue">Token Histories</a></li>
            </ul>
        </div>
    ...
    <?php
        ...
        <table id="userTable" class="display table-session" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th class="bg-secondary text-cl-white border-none text-center">Region</th>
            ...
            <tbody>
                <?php $i =1; foreach(@$data as $d){ 
                    ...
                    $usertime_dcrea = $default_dcrea+(60*$minutes);
                    ...
                    $usertime_dupd = $default_dupd+(60*$minutes);
                ...
                <tr class="text-center">
                    ...
                    <td><u><?php echo $date_dcrea."</u> <u>".$hour_dcrea; ?></u></td>
                    <td><u><?php echo $date_dupd."</u> <u>".$hour_dupd; ?></u></td>
                </tr>
