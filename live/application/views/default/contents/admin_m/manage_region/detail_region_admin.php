        ...
        <div class="pure-g">
            <div class="pure-u-8-24 profile-image text-center divider-right">
                <div class="thumb-small">
                    <?php echo form_open_multipart(site_url('admin_m/manage_region/update_region_admin_m/'), 'role="form"'); ?>
            ...
            <div class="pure-u-16-24 profile-detail prelative">
                <?php echo form_open(site_url('admin_m/manage_region/update_region_admin_m/'.$data[0]->id), 'role="form" id="form_info" data-parsley-validate' );?>
...
<div class="box">
    <div class="heading">
        ...
        <div class="pure-u-12-24 text-right" style="margin: 15px -10px;">
            <a href="<?php echo site_url('admin_m/manage_region/detail_region_partner/'.$region_id.'/1');?>" class="pure-button btn-small btn-white availability"> VIEW ALL</a>
        </div>
    </div>
