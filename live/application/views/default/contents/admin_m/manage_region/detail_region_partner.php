                ...
                foreach ($partner as $p) {
                    ...
                    <div class="grids list-people pure-u-1 pure-u-sm-12-24 pure-u-md-12-24 pure-u-lg-8-24 list">
                        ...
                        <div class="box-info" style="min-height: 110px;">
                            <div class="image">
<!--                                <a href="<?php echo site_url('admin_m/manage_partner/detail/'. $p->id); ?>">-->
                                    <img src="<?php echo base_url().'/'.$p->profile_picture;?>" class="list-cover">
<!--                                </a>    -->
                            </div>
                            <div class="detail">
<!--                                <a href="<?php echo site_url('admin_m/manage_partner/detail/'. $p->id); ?>" class="name">-->
...
<!--                                </a>-->
                            ...
                            <!-- <div class="more pure-u-1 padding-t-15">
                                <a class="pure-button btn-small btn-white btn-48 edit-partner" onclick="confirmation('<?php //echo site_url('admin_m/manage_partner/edit_partner/'. $p->id); ?>', 'group', 'Edit Partner', 'list-partner', 'edit-partner');"> 
                                    EDIT
                                </a>
                            </div> -->
                        </div>
