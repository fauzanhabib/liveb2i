...
<div class="box">
    ...
    <div class="content">
        <div class="box">
            <?php echo form_open('admin_m/manage_region/create_region_admin','role="form" class="pure-form pure-form-aligned" data-parsley-validate');?>
                <fieldset>
...
<!--                    <div class="pure-control-group">
                    ...
                    <div class="pure-control-group" style="border-top:1px solid #f3f3f3;padding: 15px 0px;">
                        <div class="label">
                            ...
                            <a href="<?php echo site_url('admin_m/manage_region/');?>" class="pure-button btn-red btn-small">CANCEL</a>
                        </div>
                    </div>
                </fieldset>
            <?php echo form_close();?>        
