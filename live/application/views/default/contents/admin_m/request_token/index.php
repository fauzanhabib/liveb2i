        ...
        <div class="heading pure-g">
            ...
            <div class="left-list-tabs pure-menu pure-menu-horizontal">
                <ul class="pure-menu-list m-l-20">
                    ...
                    <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin_m/manage_partner/history_token'); ?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Token Histories</a></li>
                </ul>
            </div>
                    ...
                    <tr class="request">
                        ...
                        <td>
                            <div class="blue-red-btn">
                                <div class="pure-button btn-green btn-small"><a onclick="confirmation('<?php echo site_url('admin_m/manage_partner/approve_token/'.@$d->id ); ?>', 'group', 'Approve Token Request', 'request', 'approve-token');" class="approve-token">Approve</a></div>
                                <div class="pure-button btn-red btn-small"><a onclick="confirmation('<?php echo site_url('admin_m/manage_partner/decline_token/'.@$d->id ); ?>', 'group', 'Decline Token Request', 'request', 'decline-token');" class="decline-token">Decline</a></div>
                            </div>
                        </td>
                    </tr>
