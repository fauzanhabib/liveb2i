...
<div class="box clear-both">
    ...
    <div class="content padding-t-10">
       <div class="box">
            ...
            <form action="<?php echo site_url('admin_m/reporting/coach/coachreport');?>" method="POST">
...
<div class="box clear-both">
    ...
    <div class="content padding-t-10">
        <div class="box">
            ...
            <form action="<?php echo site_url('admin_m/reporting/coach/export_summary');?>" method="POST" target="_blank">
                ...
                $(document).ready(function() {
                    var t = $('#large').DataTable( {
                        ...
                        "footerCallback": function ( row, data, start, end, display ) {
                            ...
                            refund = api.column( 7 ).data().reduce( function (a, b) {return intVal(a) + intVal(b);}, 0 );
                            balanc = api.column( 8 ).data().reduce( function (a, b) {return intVal(a) + intVal(b);}, 0 );
                            ...
                            abses = api.column( 11 ).data().reduce( function (a, b) {return intVal(a) + intVal(b);}, 0 );
                            rating = api.column( 12 ).data().reduce( function (a, b) {return intVal(a) + intVal(b);}, 0 );

                            // Update footer
                            $( api.column( 5 ).footer() ).html(startb);
                            $( api.column( 6 ).footer() ).html(earned);
                            $( api.column( 7 ).footer() ).html(refund);
                            $( api.column( 8 ).footer() ).html(balanc);
                            $( api.column( 9 ).footer() ).html(comses);
                            $( api.column( 10 ).footer() ).html(latses);
                            $( api.column( 11 ).footer() ).html(abses);
                            // $( api.column( 12 ).footer() ).html(rating);
            ...
            <table id="large" class="display table-session tablesorter" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="bg-secondary uncek text-cl-white border-none">Affiliate</th>
