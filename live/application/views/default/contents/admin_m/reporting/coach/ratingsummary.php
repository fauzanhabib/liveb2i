...
<div class="box clear-both">
    ...
    <div class="content padding-t-10">
        <div class="box">
            ...
            <form action="<?php echo site_url('admin_m/reporting/coach/export_rating');?>" method="POST" target="_blank">
            ...
            <table id="large" class="display table-session tablesorter" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="bg-secondary uncek text-cl-white border-none" style="cursor:pointer;">Affiliate</th>
