...
<div class="box clear-both">
    ...
    <div class="content padding-t-10">
       <div class="box">
            ...
            <form action="<?php echo site_url('admin_m/reporting/student/studentreport');?>" method="POST">
...
<div class="box clear-both">
    ...
    <div class="content padding-t-10">
        <div class="box">
            ...
            <form action="<?php echo site_url('admin_m/reporting/student/export_rpt');?>" method="POST" target="_blank">
