...
<div class="heading text-cl-primary border-b-1 padding15">
    <h1 class="margin0">Student Sessions</h1>
</div>
...
<div class="box clear-both">
    <div class="heading pure-g padding-t-30">
        <div class="left-list-tabs pure-menu pure-menu-horizontal text-center margin0">
            <ul>
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey active-tabs-blue" href="<?php echo site_url($role_link.'/student_upcoming_session/one_to_one_session/'.@$student_id);?>">Upcoming Session</a></li>
                <!-- <li><a href="<?php echo site_url('admin_m/student_upcoming_session/class_session/'.@$student_id);?>" >Class Session</a></li> -->
                <li class="pure-menu-item pure-menu-selected text-center width250 no-hover"><a class="pure-menu-link padding-t-b-5 font-16 padding-lr-0 font-light text-cl-lightGrey" href="<?php echo site_url($role_link.'/student_histories/index/'.@$student_id);?>" >Session Histories</a></li>
    ...
    <div class="margin0 padding15">
                ...
                <?php 
                echo form_open($role_link.'/student_upcoming_session/search/one_to_one/'.@$student_id, 'class="pure-form filter-form" style="border:none"'); 
                ?>
                <div class="pure-g">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="padding-10-15" data-label="COACH">
                            <!-- <a href="<?php echo site_url('admin_m/manage_partner/coach_detail/3/' . $d->coach_id); ?>"> -->
                        ...
                        <td class="padding-10-15 t-center">
                            <a href="<?php echo site_url($role_link.'/vrm/single_student/'. $d->student_id); ?>" class="pure-button btn-expand-tiny btn-primary-border">Progress Report</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
