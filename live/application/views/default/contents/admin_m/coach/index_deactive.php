...
<div class="heading text-cl-primary padding-l-20">
    ...
    <div class="tag margint30">
        <h1 class="padding-l-15 text-cl-secondary font-semi-bold">&nbsp;&nbsp;<?php echo $partner->name;?> <em class="font-26">(Coach Group)</em></h1>
    ...
    <form action="<?php echo site_url('admin_m/manage_partner/coach_action/deactive/'.$subgroup_id.'/'.$partner_id);?>" method="POST">
    ...
    <div class="left-tabs pure-menu pure-menu-horizontal padding-t-17 padding-l-170">
        <ul class="pure-menu-list padding-t-18 right">
            <li class="pure-menu-item padding-tb-9 no-hover">
                ...
                <button class="btn-small border-none bg-red text-cl-white height-32" type="submit" name="__submit" value="deactive_coach">
                    <span>Deactive</span>
                </button>
                <?php } elseif($this->auth_manager->role() == 'ADM' && @$status == 'deactive') { ?>
                <button class="btn-small border-none bg-green text-cl-white height-32" type="submit" name="__submit" value="active_coach">
                    <span>Active</span>
                </button>
                <?php } ?>
            </li>
...
<!--         <div class="delete-add-btn padding-l-10">
            <div class="btn-noborder btn-normal bg-white-fff left"><a href="<?php echo site_url($role_link.'/manage_partner/add_partner_member/'.$partner_id);?>"><img src="<?php echo base_url('assets/img/iconmonstr-plus-6-16.png');?>" class="left padding-t-1 padding-r-5"><em class="textDec-none text-cl-tertiary">Add Coach To Group</em></a></div>
            <button class="btn-noborder btn-normal bg-white-fff" type="submit" value="delete_coach" name="__submit"><img src="<?php echo base_url('assets/img/iconmonstr-x-mark-7-16.png');?>" class="left padding-t-1 padding-r-5"><em class="textDec-none text-cl-red">Delete Coach From Group</em></button>
        </div> -->
    ...
    <div class="left-list-tabs pure-menu pure-menu-horizontal padding-l-20">
        <ul class="pure-menu-list">
            ...
            <!-- <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin_m/manage_partner/member_of_coach/active/'.$subgroup_id.'/'.$partner_id);?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5 active-tabs-blue">Active Regions</a></li> -->
            <!-- <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin_m/manage_partner/member_of_coach/deactive/'.$subgroup_id.'/'.$partner_id);?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Inactive Regions</a></li> -->
            <?php } elseif($this->auth_manager->role() == 'ADM' && @$status == 'deactive'){ ?>
            <!-- <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin_m/manage_partner/member_of_coach/active/'.$subgroup_id.'/'.$partner_id);?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Active Regions</a></li> -->
            <!-- <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin_m/manage_partner/member_of_coach/deactive/'.$subgroup_id.'/'.$partner_id);?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5 active-tabs-blue">Inactive Regions</a></li> -->
            <?php } ?>
                ...
                <div class="box-lists pure-g">
                    <?php 
                        ...
                        foreach ($coaches as $coach) { 
                          if($coach->subgroup_id == $subgroup_id && $coach->status == 'disable'){
                    ?>
                    
                    <div class="box-info-list-checkbox grids list-people pure-u-1 pure-u-sm-12-24 pure-u-md-12-24 pure-u-lg-8-24 padding-b-20">
                        <!-- <input type="checkbox" id="checkbox-1-<?php echo $no;?>" name="check_list[]" value="<?php echo $coach->id;?>" class="regular-checkbox" /><label class="left m-l-min35" for="checkbox-1-<?php echo $no;?>"></label> -->
                        <div class="box-info-list">
                            <div class="list-profile-pic left">
                                <a href="<?php echo site_url($role_link.'/manage_partner/coach_detail/'.$partner_id.'/'.$coach->id);?>" class="list-profile-pic-pic">
                                    <img src="<?php echo base_url($coach->profile_picture);?>" class="img-circle">
                                </a>
                            </div>

                            <div class="list-name-details margin-left70 width206 text-center">
                                <br>
                                <a href="<?php echo site_url($role_link.'/manage_partner/coach_detail/'.$partner_id.'/'.$coach->id);?>" class="text-grey-nodecoration">
                                <span class="font-semi-bold font-18"><?php echo $coach->fullname;?></span>
                                <h5 class="margin0"><?php echo $coach->email;?></h5>
                                </a>
                            </div>
                        </div>
                    </div>
