    ...
    <div class="breadcrumb-tabs pure-g">
        <div class="left-breadcrumb">
           ...
           <?php if($role_link == 'superadmin'){ ?>
                ...
                <?php if($role_link == 'superadmin'){?>
                <li><a href="<?php echo site_url($role_link.'/manage_partner/list_partner/coach/'.$partner_id.'/'.$region_id);?>">
           ...
           <!--      <button class="btn-small border-none bg-green text-cl-white height-32" type="submit" name="__submit" value="active_coach">
            ...
            <li class="pure-menu-item padding-tb-9 no-hover">
                <a href="<?php echo $back;?>">
                    <button class="btn-small border-1-blue bg-white-fff text-cl-tertiary">
...
<!--         <div class="delete-add-btn">
   ...
   <div class="content padding-t-10">
        <div class="box">
        <form class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24" action="<?php echo site_url('admin_m/manage_partner/delete_coach/'.$this->uri->segment(5).'/'.$this->uri->segment(6));?>" method="POST">
                ...
                <tbody>
                    <?php 
                        ...
                        foreach ($coaches as $coach) { 
                          if($coach->subgroup_id == $subgroup_id && $coach->status == 'active'){
                    ?>
