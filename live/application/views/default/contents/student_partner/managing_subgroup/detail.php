    ...
    <div class="breadcrumb-tabs pure-g">
        <div class="left-breadcrumb">
            <ul class="breadcrumb toolbar padding-l-0">
                ...
                <li>
                    <form action="<?php echo site_url('student_partner/subgroup/list_student/'.$subgroup_id);?>" method="POST" autocomplete="on" class="search-box">
...
<div class="box clear-both">
    ...
    <div class="heading heading-total-session pure-g prelative">
        <form class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24" action="<?php echo site_url('student_partner/subgroup/delete_student/'.$this->uri->segment(4));?>" method="POST">
       ...
       <div class="box">
            <div class="flex--wrap justify__content--sb padding-b-5">
                ...
                <!-- <div class="search__box">
                    <input type="text" id="myInput" class="search-b" onkeyup="myFunction()" placeholder="Search for names..">
                </div> -->
            </div>
            <style type="text/css">
                div.pager {
