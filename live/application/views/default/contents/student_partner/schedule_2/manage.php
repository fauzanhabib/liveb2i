...
<div class="box">
    <div class="heading pure-g">
        ...
        <div class="pure-u-1 edit edit-no-right padding15">
            <a href="<?php echo site_url('partner/schedule/create/' . @$student_id); ?>" class="add"><i class="icon icon-add"></i>Add New Session</a>
        </div>
        <!-- end block edit -->
    </div>
                    ...
                    <tr>
                        ...
                        <td class="sm-12 padding15"> 
                            <a class="pure-button btn-small btn-white reschedule-session">
                                <span onclick="confirmation('<?php echo site_url('partner/manage_session/reschedule/' . @$student_id . '/' . @$appointment->id); ?>', 'group', 'Reschedule Session', 'manage-schedule', 'reschedule-session');">RESCHEDULE</span>
                            </a>  
                            <a class="pure-button btn-small btn-white cancel-session">
                                <span onclick="confirmation('<?php echo site_url('partner/manage_session/cancel/' . @$student_id . '/' . @$appointment->id); ?>', 'group', 'Cancel Session', 'manage-schedule', 'cancel-session');">CANCEL</span>
                            </a> 
                        </td>
                    </tr>
                    <?php } ?>
