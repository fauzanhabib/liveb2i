            ...
            <table class="table-session"> 
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="padding-10-15" style="vertical-align: middle;"> <a href="<?php echo site_url('partner/schedule/manage/'.@$user_profile->id );?>" class="pure-button btn-small btn-white">MANAGE</a></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
