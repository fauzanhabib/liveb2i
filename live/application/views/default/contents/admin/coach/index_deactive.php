...
<div class="heading text-cl-primary padding-l-20">
    ...
    <form action="<?php echo site_url('admin/manage_partner/coach_action/deactive/'.$subgroup_id.'/'.$partner_id);?>" method="POST">
...
<!--         <div class="delete-add-btn padding-l-10">
    ...
    <div class="left-list-tabs pure-menu pure-menu-horizontal padding-l-20">
        <ul class="pure-menu-list">
            ...
            <!-- <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin/manage_partner/member_of_coach/active/'.$subgroup_id.'/'.$partner_id);?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5 active-tabs-blue">Active Regions</a></li> -->
            <!-- <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin/manage_partner/member_of_coach/deactive/'.$subgroup_id.'/'.$partner_id);?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Inactive Regions</a></li> -->
            <?php } elseif($this->auth_manager->role() == 'ADM' && @$status == 'deactive'){ ?>
            <!-- <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin/manage_partner/member_of_coach/active/'.$subgroup_id.'/'.$partner_id);?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Active Regions</a></li> -->
