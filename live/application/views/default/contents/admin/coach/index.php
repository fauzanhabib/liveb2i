...
<!--         <div class="delete-add-btn">
   ...
   <div class="content padding-t-10">
        <div class="box">
        <form class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24" action="<?php echo site_url('admin/manage_partner/delete_coach/'.$this->uri->segment(5).'/'.$this->uri->segment(6));?>" method="POST">
