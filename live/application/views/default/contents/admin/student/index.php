...
<div class="heading text-cl-primary padding-l-20">
    ...
    <div class="breadcrumb-tabs pure-g">
        <div class="left-breadcrumb">
           ...
           <?php if($role_link == 'superadmin'){ ?>
                ...
                <li>
                    <?php if($role_link == 'superadmin'){ ?>
                        <form action="<?php echo site_url('superadmin/manage_partner/member_of_student/active/'.$subgroup_id.'/'.$partner_id);?>" autocomplete="on" class="search-box" method="post">
                    <?php }else{ ?>
                        <form action="<?php echo site_url('admin/manage_partner/member_of_student/active/'.$subgroup_id.'/'.$partner_id);?>" autocomplete="on" class="search-box" method="post">
                    <?php } ?>
    ...
    <!-- <form action="<?php echo site_url('admin/manage_partner/student_action/active/'.$subgroup_id.'/'.$partner_id);?>" method="POST"> -->
    ...
    <div class="left-tabs pure-menu pure-menu-horizontal padding-t-17 padding-l-170">
        <ul class="pure-menu-list padding-t-18 right">
            ...
            <a href="<?php echo site_url('admin/partner_setting/setting_partner/coach');?>">
...
<div class="box clear-both padding-t-20">
   ...
   <!--      <div class="delete-add-btn padding-l-10">
    ...
    <div class="content padding-t-10">
        <div class="box">
        <form class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24" action="<?php echo site_url('admin/manage_partner/delete_student/'.$this->uri->segment(6).'/'.$this->uri->segment(6));?>" method="POST">
