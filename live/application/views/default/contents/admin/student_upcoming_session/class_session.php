    ...
    <div class="heading pure-g">
        ...
        <div class="pure-u-1 tab-list tab-link">
            <ul>
                ...
                <li class="current"><a class="active" href="<?php echo site_url('admin/student_upcoming_session/class_session/'.@$student_id);?>" >Class Session</a></li>
                <li><a href="<?php echo site_url('admin/student_histories/index/'.@$student_id);?>" >Session Histories</a></li>
    ...
    <div class="content tab-content padding0">
        <div id="tab1" class="tab active">
            ...
            <div class="tab-edited margin0 padding15">
                ...
                <?php 
                echo form_open('admin/student_upcoming_session/search/class/'.@$student_id, 'class="pure-form filter-form" style="border:none"'); 
                ?>
                <div class="pure-g">
                    <div class="pure-u-1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="padding-10-15 t-center">
                            <a href="<?php echo site_url('admin/vrm/multiple_student/'. @$d->class_id); ?>" class="pure-button btn-medium btn-expand-tiny btn-primary-border">Progress Report</a>
                        </td>
                    </tr>
