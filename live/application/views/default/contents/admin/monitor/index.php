        ...
        <div class="content">
            <div class="box pure-g">
              <div class="pure-u-24-24 profile-detail prelative">
                <form action="<?php echo(site_url('admin/monitor/add_monitor_acc/'));?>" method="post">
...
<script type="text/javascript">
  $('.mondis').click(function(){
      ...
      $.ajax({
         type:"POST",
         url:"<?php echo site_url('admin/monitor/dis_mon');?>",
         data: {'userid':userid},
   ...
   $('.monena').click(function(){
       ...
       $.ajax({
          type:"POST",
          url:"<?php echo site_url('admin/monitor/ena_mon');?>",
          data: {'userid':userid},
          success: function(data){
            location.reload();
          }
    ...
    $('.mondel').click(function(){
        ...
        $.ajax({
           type:"POST",
           url:"<?php echo site_url('admin/monitor/del_mon');?>",
           data: {'userid':userid},
           success: function(data){
             location.reload();
           }
