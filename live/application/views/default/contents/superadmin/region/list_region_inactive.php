    ...
    <div class="heading pure-g border-none clearfix">
        ...
        <div class="left-list-tabs pure-menu pure-menu-horizontal padding-l-40 left">
            <ul class="pure-menu-list">
                ...
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('superadmin/region/index/inactive');?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5 active-tabs-blue">Inactive Regions</a></li>
            </ul>
        </div>
