...
?>
    ...
    <h1 class="margin0 padding-l-30 left">Move Partner</h1>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="add-form-noborder">
                                <?php echo form_input('region_id', set_value('region_id', @$region_name[0]->region_id), 'class="width50perc bg-white-fff padding2 border-1-ccc padding3" style="border:none" readonly') ?>
                            </td>
                            <?php } ?>
                        </tr>
                        <tr>
                            ...
                            <td class="add-form-noborder">
                                <input type="text" name="sad" value="<?php echo @$partner_name[0]->name; ?>" class="width50perc bg-white-fff padding2 border-1-ccc padding3" style="border:none" readonly>
                        ...
                        <tr>
                            ...
                            <td class="add-form-noborder">
                                ...
                                echo form_dropdown('region', @$array, 'class="width50perc bg-white-fff padding2 border-1-ccc padding3" required data-parsley-required-message="Please select affiliate`s Country"'); 
                                ?>
                            </td>
