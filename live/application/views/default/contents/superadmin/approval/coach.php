<div class="heading text-cl-primary padding15">
    ...
    <h1 class="margin0">Coach Affiliate Approval </h1>
</div>
    ...
    <div class="heading pure-g">
        ...
        <div class="left-list-tabs pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list m-l-20">
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('superadmin/manage_partner/approve_student'); ?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Student Affiliate</a></li>
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('superadmin/manage_partner/approve_coach'); ?>" class="tabs-blue-active pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Coach Affiliate</a></li>
            </ul>
        </div>
