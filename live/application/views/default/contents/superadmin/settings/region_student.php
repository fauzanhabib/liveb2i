    ...
    <div class="heading pure-g">
        ...
        <div class="left-list-tabs pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list margin-left70">
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('superadmin/settings/region/student');?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5 active-tabs-blue">Student Affiliate</a></li>
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('superadmin/settings/region');?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Coach Affiliate</a></li>
            </ul>
        </div>
