...
<div class="box clear-both">
    ...
    <div class="content">
        ...
        <table id="userTable" class="display table-session" cellspacing="0" width="100%">
            ...
            foreach(@$data as $d){ 
                ...
                <tr>
                    ...
                    <th><?php echo $d->server_dyned_pro;?></th>
                    <th><?php echo $d->pt_score;?></th>
                    <th><?php echo $d->date_of_birth;?></th>
                    <th><?php echo $d->gender;?></th>
                    <th><?php echo $d->phone;?></th>
                    <th><?php echo $d->token_for_student;?></th>
        ...
        <div>
    		<th><a href="https://idbuild.id.dyned.com/liveprod/index.php/student_partner/adding/submit_multiple_sudents" class="pure-button btn-small btn-blue">SUBMIT</a></th>
    		<th><a href="https://idbuild.id.dyned.com/liveprod/index.php/student_partner/adding/cancel/<?php echo @$data[0]->subgroup_id;?>" class="pure-button btn-small btn-red text-cl-white">CANCEL</a></th>		
    	</div>
        <?php } else { ?>
        <div>
            <th><a href="https://idbuild.id.dyned.com/liveprod/index.php/student_partner/adding/cancel/<?php echo @$data[0]->subgroup_id;?>" class="pure-button btn-small btn-red text-cl-white">BACK</a></th>
        </div>
        <?php } ?>
    </div>   
</div>
