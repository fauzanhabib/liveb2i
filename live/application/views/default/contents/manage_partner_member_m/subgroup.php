                  ...
                  <!--               <td class="text-left">
                            ...
                            if($this->auth_manager->role() == 'RAD') {
                              ...
                              ?>
                                ...
                                <td><a class="pure-button btn-blue btn-small text-cl-white" href="<?php echo site_url('superadmin_m/manage_partner/sw_opentok/'.$s->id.'/'.$partner_id.'/'.$region_id); ?>">Switch to Opentok</a></td>
                              <?php
                              }else if($raw_array == count($temp)){
                              ?>
                                <td><?php echo 'Opentok'; ?></td>
                                <td><a class="pure-button btn-green btn-small text-cl-white" href="<?php echo site_url('superadmin_m/manage_partner/sw_agora/'.$s->id.'/'.$partner_id.'/'.$region_id); ?>">Switch to Agora</a></td>
                              <?php
                              }else{
                              ?>
                                <td><?php echo 'Mixed'; ?><br />(Agora/Opentok)</td>
                                <td>
                                  <a class="pure-button btn-green btn-small text-cl-white" href="<?php echo site_url('superadmin_m/manage_partner/sw_agora/'.$s->id.'/'.$partner_id.'/'.$region_id); ?>">Switch to Agora</a>
                                  <br />
                                  <a class="pure-button btn-blue btn-small text-cl-white" href="<?php echo site_url('superadmin_m/manage_partner/sw_opentok/'.$s->id.'/'.$partner_id.'/'.$region_id); ?>" style="margin-top: 5px;">Switch to Opentok</a>
                                </td>
                              <?php
                              }
