        ...
        <div class="pure-g">
            <div class="pure-u-8-24 profile-image text-center divider-right">
                ...
                <div class="more pure-u-1 padding-t-10 list-partner">
                    <a class="pure-button btn-small btn-white btn-small delete-partner" onclick="confirmation('<?php echo site_url('admin_m/manage_partner_admin_m/delete/'.@$user->id); ?>', 'group', 'Delete Partner', 'list-partner', 'delete-partner');">
                        DELETE
                    </a>
                </div>
            </div>
            ...
            <div class="pure-u-16-24 profile-detail prelative">
                ...
                <form action="<?php echo site_url("admin_m/manage_partner_admin_m/update/".@$partner->id."/".@$user->id); ?>" method="POST" id="form-admin" data-parsley-validate>
