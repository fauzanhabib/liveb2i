...
<div class="heading text-cl-primary padding-l-20">
        ...
        <div class="left-breadcrumb">
            <ul class="breadcrumb toolbar padding-l-0">
                ...
                <?php if($role_link == 'admin'){ ?>
                    <li><a href="<?php echo site_url('admin_m/manage_partner');?>">Partner</a></li>
                <?php } ?>
    ...
    <div class="left-tabs pure-menu pure-menu-horizontal padding-t-17 padding-l-170">
        <ul class="pure-menu-list padding-t-18">
            ...
            <button class="btn-small border-1-blue bg-white-fff text-cl-tertiary height38" onclick="goBack()">
...
<div class="box clear-both">
    ...
    <div class="content">
        ...
        <div class="box bg-white clear-both">
            <div class="padding-l-70 padding-t-20">
                <div class="box-lists pure-g">
                    
                    <?php $no = 2; foreach ($subgroup as $s) { ?>
                    <div class="box-info-list-checkbox grids list-people pure-u-1 pure-u-sm-12-24 pure-u-md-12-24 pure-u-lg-8-24 padding-b-20">
                        <?php if($this->auth_manager->role() == 'RAD') { ?>
                        <input type="checkbox" id="checkbox-1-<?php echo $no;?>" name="check_list[]" value="<?php echo $s->id;?>" class="regular-checkbox" /><label class="left m-l-min35" for="checkbox-1-<?php echo $no;?>"></label>
                        <?php } ?>
                        <div class="box-info-list">
                            <div class="list-profile-pic left">
                                <a href="<?php echo site_url($role_link.'/manage_partner/member_of_'.$type.'/active/'.$s->id.'/'.$partner_id);?>" class="list-profile-pic-pic">
                            ...
                            <div class="list-name-details margin-left70 width206 text-center">
                                <div class="list-name-details-region font-semi-bold font-18">
                                    <a href="<?php echo site_url($role_link.'/manage_partner/member_of_'.$type.'/active/'.$s->id.'/'.$partner_id);?>" class="text-grey-nodecoration"><?php echo $s->name;?></a>
                                </div>
                            </div>
                        </div>
                    </div>
