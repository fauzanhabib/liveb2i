...
<!--     <div class="breadcrumb-tabs pure-g">
    ...
    <h1 class="margin0">Student Approval</h1>
</div>
    ...
    <div class="heading pure-g">
        ...
        <div class="left-list-tabs pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list m-l-20">
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin/approve_user/index/student'); ?>" class="tabs-blue-active pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Student</a></li>
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('admin/approve_user/index/coach'); ?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Coach</a></li>
            </ul>
        </div>
                    ...
                    <td class="t-center">
                        <div class="rw">
                            <div class="blue-red-btn">
                                <div class="pure-button btn-blue btn-small approve-user" onclick="confirmation('<?php echo site_url('admin/approve_user/approve/'.@$u->id.'/student' ); ?>', 'group', 'Approve User', 'approve-users', 'approve-user');">Approve</div>
                                <div class="pure-button btn-red btn-small decline-user" onclick="confirmation('<?php echo site_url('admin/approve_user/decline/'.@$u->id.'/student' ); ?>', 'group', 'Decline User', 'approve-users', 'decline-user');">Decline</div>
                            </div>
                        </div>
                    </td>
                </tr>
