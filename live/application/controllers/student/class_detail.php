...
class class_detail extends MY_Site_Controller {
    ...
    public function index() {
        ...
        $this->template->content->view('default/contents/class_detail/index', $vars);
    ...
    public function schedule($class_id = ''){
        ...
        $this->template->title = 'Class Detail';
...
//        echo('<pre>');
//        print_r($vars); exit;
        $this->template->content->view('default/contents/class_detail/detail', $vars);
    ...
    public function member($class_id = ''){
        ...
        $this->template->content->view('default/contents/class_detail/member', $vars);
        //publish template
        $this->template->publish();
    }
