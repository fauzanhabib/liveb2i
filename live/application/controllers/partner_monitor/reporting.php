...
class reporting extends MY_Site_Controller {
    ...
    public function index() {
        ...
        // echo "<pre>";
        // print_r($vars);exit();
        $this->template->content->view('default/contents/partner_monitor/reporting/index', $vars);
    ...
    $sglist = explode(",", $subgrouplist);
        ...
        if($report == "Coach Summary"){
            ...
            $this->template->content->view('default/contents/partner_monitor/reporting/coachsummary', $vars);
            $this->template->publish();
            ...
            $this->template->content->view('default/contents/partner_monitor/reporting/ratingsummary', $vars);
            $this->template->publish();
            ...
            $this->template->content->view('default/contents/partner_monitor/reporting/sessionreport', $vars);
            $this->template->publish();
        }
    }
    ...
    public function detail($user_id=""){
    	...
    	$this->template->content->view('default/contents/partner_monitor/reporting/detail', $vars);
        $this->template->publish();
    }
    ...
    public function export_summary(){
        ...
        $this->load->view('default/contents/partner_monitor/reporting/coachsummaryexp', $vars);
    }
    public function export_session(){
	    ...
	    $this->load->view('default/contents/partner_monitor/reporting/sessionreportexp', $vars);
	}
	...
	public function export_rating(){
        ...
        $this->load->view('default/contents/partner_monitor/reporting/ratingsummaryexp', $vars);
	}
