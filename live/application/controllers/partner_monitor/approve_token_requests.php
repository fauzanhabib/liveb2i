...
//            redirect('partner_monitor/approve_token_request');
//        }
//    }
//
//    // Index
//    public function index() {
//        $this->template->title = 'Approve Token Request';
//        $vars = array(
//            'data' => $this->token_request_model->get_student_request(),
//        );
//
//        //print_r($vars); exit;
...
//            $token_request = $this->token_request_model->select('id, student_id, token_amount')->where('id', $token_request_id)->get();
...
//            redirect('partner_monitor/approve_token_requests');
//        }
//        else{
