...
class approve_coach_day_off extends MY_Site_Controller {
    ...
    public function index($page='') {
        ...
        $per_page = 5;
        $uri_segment = 4;
        $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner_monitor/approve_coach_day_off/index'), count($this->coach_day_off_model->get_coach_day_off()), $per_page, $uri_segment);
        $vars = array(
    ...
    public function approve($id = '') {
        ...
        if (!$id) {
            ...
            redirect('partner_monitor/approve_coach_day_off');
        }
    ...
    public function edit($id = '', $start_date = '', $end_date = '', $page = '') {
        ...
        $fullname = $subgroup_data[0]->fullname;
            ...
            $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner_monitor/approve_coach_day_off/edit/'.@$id.'/'.@$start_date.'/'.@$end_date), count($this->appointment_model->get_appointment_for_upcoming_session('coach_id', $start_date, $end_date, $coach_id)), $per_page, $uri_segment);
