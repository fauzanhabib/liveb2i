...
class member_list extends MY_Site_Controller {
    ...
    public function update_coach(){
        ...
        if (!$this->input->post('__submit')) {
            ...
            redirect('partner_monitor/member_list');
        }
        ...
        redirect('partner_monitor/member_list/detail/'.$profile_id->user_id);
    }
    ...
    public function delete_coach($coach_id = ''){
        ...
        if($one_to_one_schedule || $class_schedule){
            ...
            redirect('partner_monitor/member_list/detail/'.$coach_id);
        }
