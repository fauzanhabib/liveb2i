...
class Webex extends MY_Site_Controller {
    ...
    public function pre_register(){
        ...
        if (!$this->form_validation->run()) {
            ...
            redirect('partner_monitor/webex/login');
        }
        
        $this->session->set_userdata($vars);
        $this->template->content->view('default/contents/webex/partner_monitor/register', $vars);
    ...
    public function pre_login(){
        ...
        $this->session->set_userdata($vars);
        $this->template->content->view('default/contents/webex/partner_monitor/login', $vars);
        $this->template->publish();
    }
    ...
    public function login(){
        ...
        $this->template->content->view('default/contents/webex/partner_monitor/form');
        $this->template->publish();
    }
    ...
    public function auto_logout(){
        $this->template->content->view('default/contents/webex/partner_monitor/auto_logout');
        $this->template->publish();
    }
    ...
    public function list_host($page=''){
        ...
        $per_page = 5;
        $uri_segment = 4;
        $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner_monitor/webex/list_host'), count($this->webex_host_model->get_host_per_partner()), $per_page, $uri_segment);
...
//        echo('<pre>');
//        print_r($vars); exit;
        $this->template->content->view('default/contents/webex/partner_monitor/list_host', $vars);
        $this->template->publish();
    }
    ...
    public function delete_host($host_id = ''){
        if(!$host_id){
            ...
            redirect('partner_monitor/webex/list_host/'); 
        }
