...
class managing extends MY_Site_Controller {
    ...
    public function set_class_schedule($class_id = '', $date = '', $action='', $class_meeting_id='') {
        ...
        if ($date <= date('Y-m-d')) {
            ...
            redirect('partner_monitor/member_list/coach/' . $class_id);
        }
        ...
        $this->template->content->view('default/contents/managing/partner_monitor/class_schedule/assign_coach_form', $vars);
...
//                        break;
    ...
    public function reschedule($appointment_id = '', $id_coach = '') {
        ...
        if ($appointment_reschedule_data) {
            ...
            redirect('partner_monitor/coach_upcoming_session/one_to_one_session/'.$id_coach);
        }
        ...
        $this->template->content->view('default/contents/managing/partner_monitor/one_to_one/index', $vars);
    ...
    public function reschedule_booking($student_id = '', $appointment_id = '', $coach_id = '', $date = '', $start_time = '', $end_time = '', $coach_cost_old = '', $coach_cost_new = '') {
        ...
        if($selisih_cost >= 0){
            if($student_token >= $selisih_cost){ 
                ...
                redirect('partner_monitor/managing/reschedule/'.$appointment_id);
            }
...
//  echo "<pre>"; print_r($isValid); exit;
        ...
        redirect('partner_monitor/coach_upcoming_session/one_to_one_session/'.$coach_id);
    }
