...
class schedule extends MY_Site_Controller {
    ...
    public function index() {
        ...
        $this->template->content->view('default/contents/partner_monitor/schedule/index', $vars);
    ...
    public function test() {
        ...
        $this->template->content->view('default/contents/partner_monitor/schedule/test');
        $this->template->publish();
    }
    ...
    public function manage($id) {
        ...
        $this->template->content->view('default/contents/partner_monitor/schedule/manage', $vars);
        $this->template->publish();
    }
    ...
    public function create($student_id='') {
        ...
        $this->template->content->view('default/contents/partner_monitor/schedule/form', $vars);
        $this->template->publish();*/
        ...
        $this->template->content->view('default/contents/partner_monitor/schedule/list_coach', $vars);
        $this->template->publish();
    }
    ...
    public function add($student_id) {
        if(!$student_id){
            ...
            redirect('partner_monitor/schedule');
        }
    ...
    public function do_reschedule($student_id='') {
        ...
        redirect('partner_monitor/schedule/manage/' . $this->input->post('student_id'));
    }
    ...
    public function availability($search_by='', $student_id='', $coach_id = '', $date_ = '') {
        ...
        $this->template->content->view('default/contents/partner_monitor/schedule/availability', $vars);
    ...
    public function schedule_detail($id = '') {
        ...
        if (!$schedule_data) {
            redirect('partner_monitor/schedule/detail/' . $id);
        }
        $schedule = array();
    ...
    public function summary_book($search_by = '', $student_id='', $coach_id = '', $date = '', $start_time = '', $end_time = '') {
        ...
        $this->template->content->view('default/contents/partner_monitor/schedule/summary_book', $vars);
        //publish template
        $this->template->publish();
    }
        ...
        try {
            ...
            if ($isValid) {
                ...
                if (in_array(array('start_time' => $start_time, 'end_time' => $end_time), $availability)) {
                    ...
                    redirect('partner_monitor/schedule/create/'.$student_id);
                }
                ...
                if ($this->db->trans_status() === true && $remain_token >= 0 && $this->isAvailable($coach_id, $date, $start_time, $end_time)) {
                    ...
                    //redirect('student/find_coaches/book_by_single_date/' . date("Y-m-d", $date));
                    redirect('partner_monitor/create/'.$student_id);
                }
            } else {
