...
class Call_loader extends MY_Site_Controller {
    ...
    $data = array(
        ...
        if($this->auth_manager->role() == "STD"){ 
            $this->load->view('contents/opentok/call_loader_view', $data);
        }else if($this->auth_manager->role() == "CCH"){
            $this->load->view('contents/opentok/call_loader_view_coach', $data);
        }
