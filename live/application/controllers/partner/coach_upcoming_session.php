...
class coach_upcoming_session extends MY_Site_Controller {
    ...
    //     $per_page = 5;
    //     $uri_segment = 4;
    //     $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/coach_upcoming_session/one_to_one_session'), count($this->appointment_model->get_appointment_for_upcoming_session('coach_id', '', '', $id)), $per_page, $uri_segment);
    ...
    //     $this->template->content->view('default/contents/partner/coach_upcoming_session/one_to_one_session', $vars);
    //     $this->template->publish();
    // }
    ...
    public function one_to_one_session($id='', $page='') {
        ...
        $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/coach_upcoming_session/one_to_one_session/'.@$id), count($this->appointment_model->get_appointment_for_upcoming_session('coach_id', '', '', $id)), $per_page, $uri_segment);
    ...
    public function class_session($page='') {
        ...
        $per_page = 5;
        $uri_segment = 4;
        $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/coach_upcoming_session/class_session'), count($this->class_meeting_day_model->get_appointment_for_upcoming_session('', '', $this->session->userdata('coach_id'))), $per_page, $uri_segment);
        ...
        $this->template->content->view('default/contents/partner/coach_upcoming_session/class_session', $vars);
        $this->template->publish();
    }
    ...
    //             redirect('partner/coach_upcoming_session/one_to_one_session');
    ...
    //     if ($session == 'one_to_one') {
    //         $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/coach_upcoming_session/search/one_to_one'), count($this->appointment_model->get_appointment_for_upcoming_session('coach_id', $this->input->post('date_from'), $this->input->post('date_to'), $this->session->userdata('coach_id'))), $per_page, $uri_segment);
    ...
    //         }
    //     } elseif ($session == 'class') {
    //         $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/coach_upcoming_session/search/class'), count($this->class_meeting_day_model->get_appointment_for_upcoming_session($this->input->post('date_from'), $this->input->post('date_to'), $this->session->userdata('coach_id'))), $per_page, $uri_segment);
    ...
    //         redirect(site_url('partner/coach_upcoming_session/one_to_one_session'));
    //     }
    ...
    //     $this->template->content->view('default/contents/partner/coach_upcoming_session/' . (($session == 'one_to_one') ? 'one_to_one_session' : 'class_session'), $vars);
    //     $this->template->publish();
    // }
        ...
        if(($this->input->post('__submit')))
    {
        if (!$this->common_function->run_validation($rules)) {
            $this->messages->add(validation_errors(), 'warning');
            if($session == 'one_to_one'){
                redirect('partner/coach_upcoming_session/one_to_one_session/'.@$id);
            }elseif($session == 'class'){
                redirect('partner/coach_upcoming_session/class_session');
            }
        }
        ...
        if ($session == 'one_to_one') {
            ...
            $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/coach_upcoming_session/search/one_to_one/'.@$id), count($this->appointment_model->get_appointment_for_upcoming_session('coach_id', $this->input->post('date_from'), $this->input->post('date_to'), $id)), $per_page, $uri_segment);
