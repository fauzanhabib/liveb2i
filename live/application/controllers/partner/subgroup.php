...
class subgroup extends MY_Site_Controller {
  ...
  //   }
    ...
    public function index($page='') {
        ...
        if($search_subgroup != ''){
            $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/subgroup/index'), count($this->identity_model->get_subgroup_identity(null,'coach',null,$search_subgroup)), 9999, $uri_segment);
    ...
    public function index_disable($page='') {
        ...
        if($search_subgroup != ''){
            $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/subgroup/index_disable'), count($this->identity_model->get_subgroup_identity(null,'coach',null,$search_subgroup)), 9999, $uri_segment);
            $data = $this->identity_model->get_subgroup_identity(null,'coach','disable',null,$search_subgroup,9999, $offset);
            $data2 = $this->identity_model->get_coach_identity('','',$this->auth_manager->partner_id(), '', 9999, $offset, '');
        } else if($search_subgroup == ''){
            $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/subgroup/index_disable'), count($this->identity_model->get_subgroup_identity(null,'coach',null,null)), $per_page, $uri_segment);
    ...
    public function list_coach($subgroup_id = '', $page='', $id='') {
        ...
        if($search_coach != ''){
            $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/subgroup/list_coach/'.$subgroup_id), count($this->identity_model->get_coach_identity('',$search_coach,'',$this->auth_manager->partner_id(),null,null,null)), 9999, $uri_segment,$subgroup_id);
