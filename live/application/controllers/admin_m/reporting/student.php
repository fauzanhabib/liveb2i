...
$id = $pull_m_id[0]->id;
        ...
        $this->template->content->view('default/contents/admin_m/reporting/student/index', $vars);
...
$id = $pull_m_id[0]->id;
    ...
    $sglist = explode(",", $subgrouplist);
        ...
        if($report == "Student Report"){
            ...
            $this->template->content->view('default/contents/admin_m/reporting/student/studentreport', $vars);
            $this->template->publish();
        }else{
            ...
            $this->template->content->view('default/contents/admin_m/reporting/student/sessionreport', $vars);
            $this->template->publish();
        }
    }
    ...
    public function export_rpt(){
        ...
        $this->load->view('default/contents/admin_m/reporting/student/export_rpt', $vars);
    }
    ...
    public function export_ses(){
        ...
        $this->load->view('default/contents/admin_m/reporting/student/export_ses', $vars);
    }
