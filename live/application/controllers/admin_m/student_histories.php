...
class Student_histories extends MY_Site_Controller {
    ...
    //     $per_page = 5;
    //     $uri_segment = 5;
    //     $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin_m/student_histories/index/'.@$student_id), count($this->appointment_model->get_session_histories('student_id', $student_id, $date_from, date('Y-m-d'))), $per_page, $uri_segment);
    ...
    //             redirect('admin_m/student_histories/index/'.@$student_id);
    //         }elseif($session == 'class'){
    //             redirect('admin_m/student_histories/class_session/'.@$student_id);
    //         }
    //     }
    ...
    //         $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin_m/student_histories/search/one_to_one/'.@$student_id), count($this->appointment_model->get_session_histories('student_id', @$student_id, $date_from, $date_to, $per_page, $offset)), $per_page, $uri_segment);
    ...
    //         $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin_m/student_histories/search/class/'.@$student_id), count($this->class_member_model->get_session_histories('student_id', @$student_id, $date_from, $date_to, $per_page, $offset)), $per_page, $uri_segment);
    ...
    public function class_session($student_id='', $page=''){
        ...
        $per_page = 5;
        $uri_segment = 5;
        $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin_m/student_histories/class_session/'.@$student_id), count($this->class_member_model->get_session_histories('student_id', $student_id, $date_from, date('Y-m-d'))), $per_page, $uri_segment);
