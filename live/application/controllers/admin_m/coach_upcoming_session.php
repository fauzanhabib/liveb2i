...
class coach_upcoming_session extends MY_Site_Controller {
    ...
    //     $per_page = 5;
    //     $uri_segment = 4;
    //     $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin_m/coach_upcoming_session/one_to_one_session'), count($this->appointment_model->get_appointment_for_upcoming_session('coach_id', '', '', $this->session->userdata('coach_id'))), $per_page, $uri_segment);
    ...
    //     $this->template->content->view('default/contents/admin_m/coach_upcoming_session/one_to_one_session', $vars);
    //     $this->template->publish();
    // }
    ...
    //     $per_page = 5;
    //     $uri_segment = 4;
    //     $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin_m/coach_upcoming_session/one_to_one_session/'.$id), count($this->appointment_model->get_appointment_for_upcoming_session('coach_id', '', '', $this->session->userdata('coach_id'))), $per_page, $uri_segment);
    ...
    public function class_session($page='') {
        ...
        $per_page = 5;
        $uri_segment = 4;
        $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin_m/coach_upcoming_session/class_session'), count($this->class_meeting_day_model->get_appointment_for_upcoming_session('', '', $this->session->userdata('coach_id'))), $per_page, $uri_segment);
        ...
        $this->template->content->view('default/contents/admin_m/coach_upcoming_session/class_session', $vars);
        $this->template->publish();
    }
    ...
    //         redirect('admin_m/coach_upcoming_session/'.$session.'_session');
    //     }
    ...
    //         $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin_m/coach_upcoming_session/search/one_to_one_session'), count($this->appointment_model->get_appointment_for_upcoming_session('coach_id', $date_from, $date_to, $this->session->userdata('coach_id'))), $per_page, $uri_segment);
    ...
    //         $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin_m/coach_upcoming_session/search/class_session'), count($this->class_meeting_day_model->get_appointment_for_upcoming_session('coach_id', $date_from, $date_to, $this->session->userdata('coach_id'))), $per_page, $uri_segment);
    ...
    //     $this->template->content->view('default/contents/admin_m/coach_upcoming_session/' . (($session == 'one_to_one') ? 'one_to_one_session' : 'class_session'), $vars);
    //     $this->template->publish();
    // }
    ...
    public function search($session = '', $id='', $page='') {
        ...
        if(($this->input->post('__submit'))) {
            if (!$this->common_function->run_validation($rules)) {
                $this->messages->add(validation_errors(), 'warning');
                if($session == 'one_to_one'){
                    redirect('admin_m/coach_upcoming_session/one_to_one_session/'.@$id);
                }elseif($session == 'class'){
                    redirect('admin_m/coach_upcoming_session/class_session');
                }
            }
        }
        ...
        $date_to = ($this->input->post('date_to') ? $this->input->post('date_to') : $this->session->userdata('date_to'));
        if(!$date_from && !$date_to){
            redirect('admin_m/coach_upcoming_session/'.$session.'_session/'.@$id);
        }
        ...
        if ($session == 'one_to_one') {
            $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin_m/coach_upcoming_session/search/one_to_one_session'), count($this->appointment_model->get_appointment_for_upcoming_session('coach_id', $date_from, $date_to, $id)), $per_page, $uri_segment);
