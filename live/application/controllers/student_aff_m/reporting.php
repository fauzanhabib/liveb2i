...
class Reporting extends MY_Site_Controller {
    ...
    public function index() {
        ...
        $this->template->content->view('default/contents/student_aff_m/reporting/reporting', $vars);
    ...
    $sglist = explode(",", $subgrouplist);
        ...
        if($report == "Student Report"){
            ...
            $this->template->content->view('default/contents/student_aff_m/reporting/studentreport', $vars);
            $this->template->publish();
            ...
            $this->template->content->view('default/contents/student_aff_m/reporting/sessionreport', $vars);
            $this->template->publish();
        }else {
          ...
          //  echo "<pre>";print_r($vars);exit();
           ...
           $this->template->content->view('default/contents/student_aff_m/reporting/studentdata', $vars);
           $this->template->publish();
    ...
    public function export_rpt(){
        ...
        $this->load->view('default/contents/student_aff_m/reporting/export_rpt', $vars);
    }
    ...
    public function export_ses(){
        ...
        $this->load->view('default/contents/student_aff_m/reporting/export_ses', $vars);
    }
    public function tokenhist($stdid=''){
        ...
        $this->template->content->view('default/contents/student_aff_m/reporting/tokenhistview', $vars);
        $this->template->publish();
    ...
    public function completed($stdid=''){
        ...
        $this->template->content->view('default/contents/student_aff_m/reporting/comses', $vars);
        $this->template->publish();
    }
    ...
    public function export_data() {
      ...
      //  echo "<pre>";print_r($vars);exit();
       ...
       $this->load->view('default/contents/student_aff_m/reporting/export_dat', $vars);
