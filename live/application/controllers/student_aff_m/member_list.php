...
class member_list extends MY_Site_Controller {
    ...
    public function subgroup(){
        ...
        $this->template->content->view('default/contents/member_list_affm/student/subgroup/index', $vars);
    ...
    public function student($subgroup_id = '',$page=''){
        ...
        $per_page = 6;
        $uri_segment = 4;
        $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('student_partner/member_list_affm/student'.$subgroup_id), count($this->identity_model->get_student_identity('','',$this->auth_manager->partner_id(),$subgroup_id)), $per_page, $uri_segment);
        ...
        $this->template->content->view('default/contents/member_list_affm/student/index', $vars);
        $this->template->publish();
    }
    ...
    public function edit_student($student_id =''){
        ...
        //print_r($vars); exit;
        $this->template->content->view('default/contents/member_list_affm/student/form', $vars);
        $this->template->publish();
    }
    ...
    public function update_student($student_id = ''){
        ...
        if (!$this->input->post('__submit')) {
            ...
            redirect('student_partner/member_list_affm/student_detail/'.$student_id);
        }
        ...
        redirect('student_partner/member_list_affm/student_detail/'.$profile_id->user_id);
    }
    ...
    public function delete_student($student_id = ''){
        ...
        redirect('student_partner/member_list_affm/student');
    }
    ...
    public function student_detail($student_id='',$subgroup_id=''){
        ...
        // die();
        $this->session->set_userdata("student_list_id", $student_id);
        $this->template->content->view('default/contents/member_list_affm/student/detail', $vars);
        $this->template->publish();
    }
    ...
    function add_token($student_id='',$subgroup_id=''){
        ...
        $link = base_url().'index.php/student_partner/member_list_affm/action_add_token/'.$student_id.'/'.$subgroup_id;
        $cancel = base_url().'index.php/student_partner/member_list_affm/student_detail/'.$student_id.'/'.$subgroup_id;
        $vars = array(
                'link' => $link,
                'cancel' => $cancel,
                'token' => $token
    ...
    function action_add_token($student_id = '',$subgroup_id = ''){
        ...
        if (!$this->input->post('token') || $this->input->post('token') <=0) {
            ...
            redirect('student_partner/member_list_affm/add_token/'.$student_id.'/'.$subgroup_id);
        }
        ...
        redirect('student_partner/member_list_affm/student_detail/'.$student_id.'/'.$subgroup_id);
