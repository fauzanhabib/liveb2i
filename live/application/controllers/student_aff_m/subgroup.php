...
class subgroup extends MY_Site_Controller {
    ...
    public function index($page='') {
        ...
        if($search_subgroup != ''){
            $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('student_aff_m/subgroup/index'), count($this->identity_model->get_subgroup_identity(null,'student',null, $search_subgroup)), $per_page, $uri_segment);
    ...
    //---------------------------------------------------------------------------------------------------------------------
     ...
     public function list_student($subgroup_id = '', $page='') {
        ...
        $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('student_aff_m/subgroup/list_student/'.$subgroup_id), count($this->identity_model->get_student_identity('','',$this->auth_manager->partner_id(),'')), $per_page, $uri_segment);
