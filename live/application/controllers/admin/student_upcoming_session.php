...
class Student_upcoming_session extends MY_Site_Controller {
    ...
    public function class_session($student_id='', $page='') {
        ...
        $per_page = 5;
        $uri_segment = 5;
        $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('admin/student_upcoming_session/class_session/'.@$student_id), count($this->class_member_model->get_appointment_for_upcoming_session('', '', @$student_id)), $per_page, $uri_segment);
