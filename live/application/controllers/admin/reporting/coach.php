...
class Coach extends MY_Site_Controller {
    ...
    public function index() {
        ...
        $this->template->content->view('default/contents/admin/reporting/coach/index', $vars);
    ...
    $sglist = explode(",", $subgrouplist);
        ...
        if($report == "Coach Summary"){
         ...
         //    $standard_coach_cost = $setting[0]->standard_coach_cost;
            ...
            $this->template->content->view('default/contents/admin/reporting/coach/ratingsummary', $vars);
            $this->template->publish();
            ...
            $this->template->content->view('default/contents/admin/reporting/coach/sessionreport', $vars);
            $this->template->publish();
        }
    }
