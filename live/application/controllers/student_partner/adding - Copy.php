...
class adding extends MY_Site_Controller {
    ...
    public function student() {
        ...
        //print_r($setting->max_student); exit;
    ...
    public function create_student() {
        ...
        if(@$student_member >= @$setting->max_student){
        ...
        //sending notification and email to approve student
...
//                'email' => $email->email,
//                'content' => 'A new student has been added , Please approve or decline it.',
//            );
//        }
...
//                print_r($filesop); exit;
                ...
                if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                    ...
                    if (!$this->isValidEmail($email)) {
                        ...
                        $data_token = array(
                            'user_id' => $user_id,
                            'token_amount' => $setting->token_for_student,
                        );
