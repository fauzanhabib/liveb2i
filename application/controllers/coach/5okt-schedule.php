...
//                        break;
    ...
    private function convertTime($time = ''){
        if(date("H:i", strtotime(1 . 'minutes', strtotime($time))) != '00:00' && date("i", strtotime(1 . 'minutes', strtotime($time))) != '01' && date("i", strtotime(1 . 'minutes', strtotime($time))) != '21' && date("i", strtotime(1 . 'minutes', strtotime($time))) != '41' && date("i", strtotime(1 . 'minutes', strtotime($time))) != '31'){
...
//        print_r($schedule_gmt0_2); exit;
        ...
        $a = $this->schedule_offwork_block(array_map("unserialize", array_unique(array_map("serialize", $schedule_array1))));
