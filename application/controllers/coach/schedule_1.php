...
class schedule extends MY_Site_Controller {
	...
	public function index()
	{
        ...
        public function update(){
            ...
            //$this->session->userdata("day_schedule");
            $schedule_id = $this->schedule_model->select('id')->where('user_id',$this->auth_manager->userid())->where('day',$this->session->userdata("day_schedule"))->get();
            $offwork_id = $this->offwork_model->get_offwork($this->auth_manager->userid(), $this->session->userdata("day_schedule"));
