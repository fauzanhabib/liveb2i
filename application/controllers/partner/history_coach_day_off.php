...
class history_coach_day_off extends MY_Site_Controller {
    ...
    public function index($page='') {
        ...
        $per_page = 5;
        $uri_segment = 4;
        $pagination = $this->common_function->create_link_pagination($page, $offset, site_url('partner/history_coach_day_off/index'), count($this->coach_day_off_model_history->get_coach_day_off()), $per_page, $uri_segment);
        $vars = array(
