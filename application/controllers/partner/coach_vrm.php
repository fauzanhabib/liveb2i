...
class Coach_vrm extends MY_Site_Controller {
    ...
    public function index(){
        ...
        $this->template->content->view('default/contents/vrm/coach_partner/index', $vars);
    ...
    public function student_vrm($student_id = ''){
        ...
        if($data_dyned_pro[0]->dyned_pro_id && $data_dyned_pro[0]->server_dyned_pro){
               ...
               $vars = array(
                ...
                $this->template->content->view('default/contents/vrm/coach_partner/detail_student', $vars);
                $this->template->publish();   
