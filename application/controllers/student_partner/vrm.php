...
class Vrm extends MY_Site_Controller {
    ...
    public function single_student($student_id = ''){
        ...
        $data_dyned_pro = $this->db->select('*')
                        ->from('user_profiles')
                        ->where('user_id', $student_id)
                        ->get()->result();
        // print_r($data_dyned_pro);exit();
        if($data_dyned_pro[0]->dyned_pro_id && $data_dyned_pro[0]->server_dyned_pro){
               ...
               if($checkCallOne){
                    ...
                    if(isset($nde1)){
                    $nde1;$pcnde1;
                    }else{$nde1 = 'Unit 1';$pcnde1 = 0;}
                    
                    if(isset($nde2)){
                    $nde2;$pcnde2;
                    }else{$nde2 = 'Unit 2';$pcnde2 = 0;}
                    
                    if(isset($nde3)){
                    $nde3;$pcnde3;
                    }else{$nde3 = 'Unit 3';$pcnde3 = 0;}
                    
                    if(isset($nde4)){
                    $nde4;$pcnde4;
                    }else{$nde4 = 'Unit 4';$pcnde4 = 0;}
                    
                    if(isset($nde5)){
                    $nde5;$pcnde5;
                    }else{$nde5 = 'Unit 5';$pcnde5 = 0;}
                    
                    if(isset($nde6)){
                    $nde6;$pcnde6;
                    }else{$nde6 = 'Unit 6';$pcnde6 = 0;}
                    
                    if(isset($nde7)){
                    $nde7;$pcnde7;
                    }else{$nde7 = 'Unit 7';$pcnde7 = 0;}

                    if(isset($nde8)){
                    $nde8;$pcnde8;
                    }else{$nde8 = 'Unit 8';$pcnde8 = 0;}
               ...
               $std_name = $data_dyned_pro[0]->fullname;

                $this->template->title = $std_name;
...
//        print_r($vars);exit;
        ...
        $this->template->content->view('default/contents/vrm/student_partner/index', $vars);
        $this->template->publish();
    }
