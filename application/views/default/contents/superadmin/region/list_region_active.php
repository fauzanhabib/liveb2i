<div class="heading text-cl-primary padding15">
    ...
    <div class="padding-l-240 padding-t-5">
        ...
        <form action="<?php echo base_url();?>index.php/superadmin/region/region_active" method="post">
        <div class="padding-l-10 left">
            <button class="btn-small border-none bg-red text-cl-white height-32" type="submit" name="_submit" value="deactive" onclick="return confirm('Are you sure you want to deactive?')">
                <span>Deactive</span>
            </button>
        </div> 
    ...
    <div class="heading pure-g border-none clearfix">
        ...
        <div class="left-list-tabs pure-menu pure-menu-horizontal padding-l-40 left">
            <ul class="pure-menu-list">
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('superadmin/region/index/active');?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5 active-tabs-blue">Active Regions</a></li>
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('superadmin/region/index/deactivate');?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Deactivate Regions</a></li>
            </ul>
        </div>
