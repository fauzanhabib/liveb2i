<div class="heading text-cl-primary padding15">
    <h1 class="margin0">Upcoming Sessions</h1>
</div>
...
<div class="box">
    <div class="heading pure-g">
        ...
        <div class="pure-u-1 tab-list tab-link">
            <ul>
                ...
                <li class="current"><a href="<?php echo site_url('coach/upcoming_session');?>" class="active">Upcoming Sessions</a></li>
    ...
    <div class="content tab-content padding0">
        <div id="tab1" class="tab active">
            ...
            <h3 class="padding15">ONE-TO-ONE SESSIONS</h3>
            ...
            <table id="thetable" class="table-sessions" style="border-top:1px solid #f3f3f3"> 
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="time padding-10-15 md-none text-cl-green"><?php echo(date('H:i',strtotime(@$d->start_time)));?></td>
                        <td class="time padding-10-15 md-none text-cl-green"><?php echo(date('H:i',strtotime(@$d->end_time)));?></td>
            ...
            <h3 class="padding15">CLASS SESSIONS</h3>
            <?php
            $j = 1;
            if (@$data_class) {
            ?>    
            <table id="thetable2" class="table-sessions" style="border-top:1px solid #f3f3f3"> 
                <thead>
                    <tr>
                        <th class="padding15 sm-12 tb-ses-up">DATE</th>
                        <th class="padding15 md-none">START TIME</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="time padding-10-15 md-none text-cl-green"><?php echo(date('H:i',strtotime(@$d->start_time)));?></td>
                        <td class="time padding-10-15 md-none text-cl-green"><?php echo(date('H:i',strtotime(@$d->end_time)));?></td>
                        <td class="padding-10-15 md-none"><a href="<?php echo site_url('coach/class_detail/schedule/'.@$d->class_id);?>" class="text-cl-primary"><?php echo @$d->class_name; ?></a></td>
                        <td class="padding-10-15 sm-12">
                            <a href="<?php echo site_url('coach/coach_vrm/multiple_student/'. @$d->class_id); ?>" class="pure-button btn-medium btn-expand-tiny btn-white">Progress <div class="md-none" style='display:inline-block'>Report</div></a>
                        </td>
                    </tr>
