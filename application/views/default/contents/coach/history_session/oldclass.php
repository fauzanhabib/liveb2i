        ...
        <div class="left-list-tabs pure-menu pure-menu-horizontal margin0">
            <ul class="pure-menu-list padding-l-20">
               <?php if($this->auth_manager->role()=='ADM' && @$user=='coach'){?>
                    ...
                    <li class="pure-menu-item pure-menu-selected no-hover"><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20" href="<?php echo site_url('admin/coach_histories');?>">Session Histories</a></li>
                    <li class="pure-menu-item pure-menu-selected no-hover" ><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20 current active-tabs-blue" class="active" href="<?php echo site_url('admin/coach_histories/class_session');?>">Class Session Histories</a></li>
                <?php }
                elseif($this->auth_manager->role()=='SPR'){?>
                    ...
                    <li class="pure-menu-item pure-menu-selected no-hover"><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20" href="<?php echo site_url('student_partner/student_histories/index/'.@$student_id);?>">Session Histories</a></li>
                    <li class="pure-menu-item pure-menu-selected no-hover" ><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20 current active-tabs-blue" class="active" href="<?php echo site_url('student_partner/student_histories/class_session/'.@$student_id);?>">Class Session Histories</a></li>
                <?php }
                elseif($this->auth_manager->role()=='RAD' && @$user=='coach'){?>
                    ...
                    <li class="pure-menu-item pure-menu-selected no-hover"><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20" href="<?php echo site_url('superadmin/coach_histories/index/'.@$coach);?>">Session Histories</a></li>
                    <li class="pure-menu-item pure-menu-selected no-hover" ><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20 current active-tabs-blue" class="active" href="<?php echo site_url('superadmin/coach_histories/class_session/'.@$coach);?>">Class Session Histories</a></li>
                <?php }
                elseif($this->auth_manager->role()=='ADM' && $user=='student'){ ?>
                    ...
                    <li class="pure-menu-item pure-menu-selected no-hover"><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20" href="<?php echo site_url('admin/student_histories/index/'.@$student_id);?>">Session Histories</a></li>
                    <li class="pure-menu-item pure-menu-selected no-hover" ><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20 current active-tabs-blue" class="active" href="<?php echo site_url('admin/student_histories/class_session/'.@$student_id);?>">Class Session Histories</a></li>
                <?php }
                elseif($this->auth_manager->role()=='RAD' && $user=='student'){ ?>
                    ...
                    <li class="pure-menu-item pure-menu-selected no-hover"><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20" href="<?php echo site_url('superadmin/student_histories/index/'.@$coach);?>">Session Histories</a></li>
                    <li class="pure-menu-item pure-menu-selected no-hover" ><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20 current active-tabs-blue" class="active" href="<?php echo site_url('superadminadmin/student_histories/class_session/'.@$coach);?>">Class Session Histories</a></li>
                <?php }
                elseif($this->auth_manager->role()=='PRT'){?>
                    ...
                    <li class="pure-menu-item pure-menu-selected no-hover"><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20" href="<?php echo site_url('partner/coach_histories');?>">Session Histories</a></li>
                    <li class="pure-menu-item pure-menu-selected no-hover" ><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20 current active-tabs-blue" href="<?php echo site_url('partner/coach_histories/class_session');?>" class="active">Class Session Histories</a></li>
                <?php }elseif ($this->auth_manager->role() == 'CCH') {?>
                    ...
                    <li class="pure-menu-item pure-menu-selected no-hover"><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20" href="<?php echo site_url('coach/histories');?>">Session Histories</a></li>
                    <li class="pure-menu-item pure-menu-selected no-hover" ><a class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-20 current active-tabs-blue" href="<?php echo site_url('coach/histories/class_session');?>" class="active">Class Session Histories</a></li>
                <?php } ?>
            </ul>
        </div>
        ...
        <table id="userTable" class="display" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th class="text-cl-grey border-none">CLASS NAME</th>
                    <th class="text-cl-grey border-none">SESSION DATE</th>
                    <th class="text-cl-grey border-none">TIME</th>
                    <th class="text-cl-grey border-none">SESSION RECORDED</th>
                ...
                <?php foreach (@$histories as $history) { ?>               
                 <tr>
                    ...
                    <?php if(($this->auth_manager->role() == 'PRT') || ($this->auth_manager->role() == 'ADM') || ($this->auth_manager->role() == 'RAD')){ ?>
                        <td class="text-cl-grey border-none"><span><?php echo($history->class_name); ?></span></td>
                        <?php
                        }else{
                            ?>
                        <td class="text-cl-grey border-none"><span><a href="<?php echo site_url('student_partner/managing/class_schedule/'.$class_detail.$history->class_id);?>"><?php echo($history->class_name); ?></a></span></td>
                        <?php
                        }?>
