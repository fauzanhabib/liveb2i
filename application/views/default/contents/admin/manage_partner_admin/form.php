...
<div class="box">
    ...
    <div class="content">
        <div class="box">
            <?php echo form_open('admin/manage_partner_admin/'.@$form_action.'/'.@$partner_id.'/'.@$data[0]->id, 'role="form" class="pure-form pure-form-aligned"');?>
                <fieldset>
                    ...
                    <div class="pure-control-group" style="border-top:1px solid #f3f3f3;padding: 15px 0px;">
                        <div class="label">
                            ...
                            <a href="<?php echo site_url('admin/manage_partner/list_partner_member/'.$selected) ?>" class="pure-button btn-red btn-small">CANCEL</a>
                        </div>
                    </div>
                </fieldset>
            <?php echo form_close();?>        
