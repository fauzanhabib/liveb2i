...
<div class="box">
    <div class="heading pure-g">
        <div class="pure-u-1 edit no-left">
            <a href="<?php echo site_url('admin/manage_region/add_region_admin');?>" class="add"><i class="icon icon-add"></i> Add Region Admin</a>
            <a href="<?php echo site_url('admin/manage_region/manage_region_admin');?>" class="add"><i class="icon icon-setting"></i> Manage Admin</a>
        </div>
        <!-- end block edit -->
    </div>
                    ...
                    <div class="grids list-people pure-u-1 pure-u-sm-12-24 pure-u-md-12-24 pure-u-lg-8-24 list">
                        ...
                        <div class="box-info">
                            ...
                            <div class="detail">
                                ...
                                <span class="name"><a href="<?php echo site_url('admin/manage_region/detail_region_admin/'.$d->id);?>"><?php echo($d->fullname);?></a></span>
...
<!--                                    <tr>
                            ...
                            <div class="more pure-u-1 padding-t-15">
                                <a href="<?php echo site_url('admin/manage_region/detail_region_admin/'.$d->id);?>" class="pure-button btn-small btn-white btn-48">
                                    VIEW
                                </a>
