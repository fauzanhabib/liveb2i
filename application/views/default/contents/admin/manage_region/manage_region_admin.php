                    ...
                    <tr>
                        ...
                        <?php
                            if($d->status == 'active'){ ?>
                                ...
                                <td class="padding15">
                                    <div class="rw">
                                        <a onclick="confirmation('<?php echo(site_url('admin/manage_region/deactivated_region_admin/'.$d->id));?>', 'group', 'Deactivated Admin', 'list-admins', 'admin-deactivated');" class="pure-button btn-small btn-white b-100 admin-deactivated" style="width:85px">Deactivated</a>
                                    </div>
                                </td>
                        <?php
                            }
                                ...
                                <td class="padding15">
                                    <div class="rw">
                                        <a onclick="confirmation('<?php echo(site_url('admin/manage_region/activated_region_admin/'.$d->id));?>', 'group', 'Activate Admin', 'list-admins', 'admin-active');" class="pure-button btn-small btn-white b-100 admin-active" style="width:85px">Activated</a>
                                    </div>
                                </td>
                        <?php
                            }
