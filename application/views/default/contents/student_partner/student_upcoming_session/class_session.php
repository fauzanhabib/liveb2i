    ...
    <div class="heading pure-g">
        ...
        <div class="pure-u-1 tab-list tab-link">
            <ul>
                ...
                <li class="current"><a class="active" href="<?php echo site_url('student_partner/student_upcoming_session/class_session/'.@$student_id);?>" >Class Session</a></li>
                <li><a href="<?php echo site_url('student_partner/student_histories/index/'.@$student_id);?>" >Session Histories</a></li>
    ...
    <div class="content tab-content padding0">
        <div id="tab1" class="tab active">
            ...
            <div class="tab-edited margin0 padding15">
                ...
                <?php 
                echo form_open('student_partner/student_upcoming_session/search/class/'.@$student_id, 'class="pure-form filter-form" style="border:none"'); 
                ?>
                <div class="pure-g">
                    <div class="pure-u-1">
                        ...
                        <div class="frm-date" style="display:inline-block">
                            <input name="date_to" class="datepicker2 frm-date margin0" type="text" readonly="" placeholder="Start Date">  
                            <span class="icon icon-date"></span>
                        </div>
            ...
            <table class="table-session" style="border-top:1px solid #f3f3f3"> 
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="padding-10-15" data-label="TIME"><span class="time"><?php echo(date('H:i',strtotime(@$d->start_time)));?> - <?php echo(date('H:i',strtotime(@$d->end_time)));?></span></td>
                        <td class="padding-10-15" data-label="CLASS"><a href="<?php echo site_url('student_partner/managing/class_schedule/'.@$d->class_id);?>" class="text-cl-primary"><?php echo @$d->class_name; ?></a></td>
                        <td class="padding-10-15 sm-12">
                            <a href="<?php echo site_url('student_partner/vrm/single_student'. @$student_id); ?>" class="pure-button btn-medium btn-expand-tiny btn-white">Progress Report</a>
                        </td>
                    </tr>
