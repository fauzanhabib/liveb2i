...
<div class="box">
    ...
    <div class="content">
        <div class="box pure-g">
            <?php echo form_open_multipart('student_partner/subgroup/create_subgroup', 'role="form" class="pure-form pure-form-aligned" style="width:100%" data-parsley-validate'); ?>
            ...
            <div class="pure-u-1" style="border-top:1px solid #f3f3f3;padding: 15px 0px;margin-top:15px;">
                <div class="label">
                    ...
                    <a href="<?php echo site_url('student_partner/subgroup') ?>" class="pure-button btn-small btn-red text-cl-white">CANCEL</a>
                </div>
            </div>
            <?php echo form_close(); ?> 
        </div>
