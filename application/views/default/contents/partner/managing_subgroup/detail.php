    ...
    <div class="left-tabs pure-menu pure-menu-horizontal padding-t-17 padding-l-170">
        <ul class="pure-menu-list padding-t-18 right">
            <li class="pure-menu-item padding-tb-9 no-hover">
                <a href="<?php echo site_url('partner/subgroup');?>">
...
<div class="box clear-both">
    ...
    <div class="heading heading-total-session pure-g prelative">
        <form class="pure-g pure-u-md-24-24 pure-u-sm-24-24 pure-u-lg-24-24" action="<?php echo site_url('partner/subgroup/delete_coach/'.$this->uri->segment(4));?>" method="POST">
        <div class="delete-add-btn padding-l-10 padding-t-65 pure-u-md-8-24 pure-u-lg-10-24">
            <div class="btn-noborder btn-normal bg-white-fff left"><a href="<?php echo site_url('partner/subgroup/coach/'.@$subgroup_id ); ?>"><img src="<?php echo base_url();?>assets//img/iconmonstr-plus-6-16.png" class="left padding-t-1 padding-r-5"><em class="textDec-none text-cl-tertiary">Add Coach To Group</em></a></div>
