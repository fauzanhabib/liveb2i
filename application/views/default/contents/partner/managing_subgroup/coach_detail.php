                ...
                <div class="pure-u-6-24 text-center profile-image">
                    ...
                    <div class="padding-t-10 m-b-15 text-center">
                        <div class="padding10" style="width:85%;margin:0 auto">
                            ...
                            <a href="<?php echo site_url('partner/coach_upcoming_session/one_to_one_session/'.@$coach_id);?>" class="pure-button btn-small btn-white m-t-10" >SESSIONS</a>
...
//        });
        ...
        $(".date_available").on('change', function () {
            //alert(this.name);
            var loadUrl = "<?php echo site_url('partner/find_coaches/availability/name'); ?>" + "/" + this.name + "/" + $(this).val();
        ...
        $(".weekly_schedule").click(function () {
            //alert(this.name);
            var loadUrl = "<?php echo site_url('partner/find_coaches/schedule_detail'); ?>" + "/" + this.value;
            var m = $('[id^=result_]').html($('[id^=result_]').val());
