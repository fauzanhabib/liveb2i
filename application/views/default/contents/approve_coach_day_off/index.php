...
<div class="heading text-cl-primary padding-l-20">
    ...
    <h1 class="margin0 padding-l-20 left">Day-off Approval &nbsp;</h1>
    ...
    <div class="heading pure-g">
        ...
        <div class="left-list-tabs pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list padding-l-20">
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('partner/approve_coach_day_off'); ?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5 active-tabs-blue">Day-off Requests</a></li>
                <li class="pure-menu-item pure-menu-selected no-hover"><a href="<?php echo site_url('partner/history_coach_day_off'); ?>" class="pure-menu-link padding-t-b-5 font-semi-bold font-14 padding-lr-5">Day-off Histories</a></li>
            </ul>
        </div>
