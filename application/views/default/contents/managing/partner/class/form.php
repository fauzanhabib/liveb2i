        ...
        <div class="box">
            ...
            <fieldset>
                ...
                <div class="pure-control-group">
                    ...
                    <div class="input">
                        <?php echo form_input('student_amount', set_value('student_amount', @$data->student_amount), 'id="student_amount" class="pure-input-1-2" data-parsley-type="digits" required data-parsley-required-message="Please input student amount" data-parsley-type-message="Please input number only"') ?>
                    </div>
                </div>
