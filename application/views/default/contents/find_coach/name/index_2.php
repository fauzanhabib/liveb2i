<div class="heading text-cl-primary padding15">
    <h1 class="margin0"><small>Book a Coach</small></h1>
</div>
        ...
        <div class="box">
            ...
            for($i=0;$i<count($coaches);$i++){
                ...
                <div class="grids list-people pure-u-1 pure-u-sm-12-24 pure-u-md-12-24 pure-u-lg-8-24 list">
                    <div class="box-info">
                        <div class="image">
                            <img src="<?php echo base_url().$coaches[$i]->profile_picture;?>" style="width:125px;height:129px">
                        </div>
                        <div class="detail">
                    ...
                    ?>
                    <div class="view-schedule hide" style="position:relative">
                    <?php
                    }else{
                    ?>
                        ...
                        <div class="box-schedule">
                            <div class="date pure-form pure-g" value="<?php echo($coaches[$i]->id);?>">
                                <div class="pure-u-2-5">
                                    <input class="date_available datepicker frm-date" type="text" name="<?php echo($coaches[$i]->id);?>" readonly>     
                                </div>
