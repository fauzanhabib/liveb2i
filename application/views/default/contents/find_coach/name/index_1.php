...
<div class="box">
    <div class="heading pure-g">
        ...
        <div class="pure-u-12-24 edit">
            ...
            <a href="<?php echo site_url('student/find_coaches/search/name'); ?>" class="active">Name</a>
                    ...
                    <div class="list-coach-box">
                        <div class="pure-g">
                            ...
                            <div class="pure-u-2-5 photo">
                                <img src="<?php echo base_url().$coaches[$i]->profile_picture; ?>" width="125" height="129">
                            </div>
    ...
    <!--								<tr>
                    ...
                    <?php 
                    if($i >= (count($coaches)-3)){
                        ?>
                    <div class="view-schedule" style="display:none; position:relative">
                    <?php
                    }else{
                        ?>
                    ...
                    ?>
                        ...
                        <div class="pure-form">
                            <div class="date" value="<?php echo($coaches[$i]->id);?>">
                                <input class="date_available datepicker frm-date" type="text" name="<?php echo($coaches[$i]->id);?>" readonly> <span><button class="weekly_schedule" value="<?php echo($coaches[$i]->id);?>" style="background:none;border:none;" class="link">Weekly Schedule</button></span>
                            </div>
...
//        });
        ...
        $(".date_available").on('change', function() {
            //alert(this.name);
            var loadUrl = "<?php echo site_url('student/find_coaches/availability/name'); ?>"+ "/" +this.name+ "/" +$(this).val();
            //alert(loadUrl);
            if($(this).val() != ''){
                $("#schedule-loading").show();
