<div class="heading text-cl-primary padding15">
    <h1 class="margin0">Spesific Setting</h1>
</div>
<div class="box b-f3-2">
    ...
    <div class="content padding0">
        ...
        <div class="list-frm">
            <?php echo form_open_multipart('', 'id="form" role="form" class="pure-form pure-form-aligned padding15" data-parsley-validate'); ?>
            <div class="heading pure-g">
                ...
                <fieldset>
                    <div class="pure-control-group" style="margin-bottom:8px">
                        ...
                        <div class="input">
                            <span class="r-only">10</span>
                            <input name="max_student" type="text" class="pure-input-1-2 e-only" value="10" data-parsley-type="digits" required data-parsley-required-message="This field can’t be blank" data-parsley-type-message="Please input numbers only">
                        </div>
                    </div>
                    ...
                    <div class="pure-control-group" style="margin-bottom:8px">
                        ...
                        <div class="input">
                            <span class="r-only">10</span>
                            <input name="token_for_student" type="text" class="pure-input-1-2 e-only" value="10" data-parsley-type="digits" required data-parsley-required-message="This field can’t be blank" data-parsley-type-message="Please input numbers only">
                        </div>
                    </div>
                    <div class="b-f3-1"></div>
                </fieldset>
        ...
        <div class="list-frm">
            <?php echo form_open_multipart('', 'role="form" class="pure-form pure-form-aligned padding15"'); ?>
            <div class="heading pure-g">
                <div class="pure-u-12-24">
            ...
            <?php //echo form_open_multipart('admin/partner_setting/update_setting/coach', 'role="form"'); ?>
                <fieldset>
                    <div class="pure-control-group" style="margin: 10px 0px 15px;">
                        ...
                        <div class="input">
                            <span class="r-only">20 Minutes</span>
                            <div class="pure-g  e-only">
                                <div class="pure-u-1 m-b-5">
                                    <label class="radio d-i-block m-b-15">
                                        <input type="radio" name="session_duration" value="20" checked="true">
                                ...
                                <div class="pure-u-1">
                                    <label class="radio d-i-block m-b-15">
                                        <input type="radio" name="session_duration" value="30">
                                        <span class="outer m-r-10"><span class="inner"></span></span>
                                        30 Minutes
                                    </label>
                                </div>
