...
<div class="box b-f3-2">
    ...
    <div class="content padding0">
        ...
        <div class="list-frm">
            <!-- <?php echo form_open_multipart('admin/partner_setting/update_setting_partner/'.$data->user_id.'/'.$this->uri->segment(4), 'id="form" role="form" class="pure-form pure-form-aligned padding15" data-parsley-validate'); ?> -->
            ...
            <div class="heading pure-g">
                ...
                <fieldset>
                    <div class="pure-control-group" style="margin-bottom:8px">
                        <h4 class="m-b-15">Set Maximum Token For Partner</h4>
                        <div class="label">
                            <label for="student">Max Token</label>
                        </div>
                        <div class="input">
                            <span class="r-only"><?php echo(@$data->max_token); ?></span>
                            <input name="max_token" type="text" class="pure-input-1-2 e-only" value="<?php echo (@$data->max_token);?>" data-parsley-type="digits" required data-parsley-required-message="This field can’t be blank" data-parsley-type-message="Please input numbers only">
                        </div>
                    </div>
                    ...
                    <div class="pure-control-group" style="margin-bottom:8px">
                        ...
                        <div class="input">
                            <span class="r-only"><?php echo(@$data->max_token_for_student); ?></span>
                           <input name="max_token_for_student" type="text" class="pure-input-1-2 e-only" value="<?php echo(@$data->max_token_for_student); ?>" data-parsley-type="digits" required data-parsley-required-message="This field can’t be blank" data-parsley-type-message="Please input numbers only">
                    ...
                    <div class="pure-control-group" style="margin-bottom:8px">
                        ...
                        <div class="input">
                            <span class="r-only"><?php echo(@$data->max_student_class); ?></span>
                            <input name="max_student_class" type="text" class="pure-input-1-2 e-only" value="<?php echo(@$data->max_student_class); ?>" data-parsley-type="digits" required data-parsley-required-message="This field can’t be blank" data-parsley-type-message="Please input numbers only">
                        </div>
                    </div>
                    <div class="b-f3-1"></div>
                     <div class="pure-control-group" style="margin-bottom:8px">
                        ...
                        <div class="input">
                            ...
                            <input name="max_student_supplier" type="text" class="pure-input-1-2 e-only" value="<?php echo(@$data->max_student_supplier); ?>" data-parsley-type="digits" required data-parsley-required-message="This field can’t be blank" data-parsley-type-message="Please input numbers only">
                        </div>
                    </div>
                    <div class="b-f3-1"></div>
                    <div class="pure-control-group" style="margin-bottom:8px">
                        ...
                        <div class="input">
                            ...
                            <input name="max_day_per_week" type="text" class="pure-input-1-2 e-only" value="<?php echo(@$data->max_day_per_week); ?>" data-parsley-type="digits" required data-parsley-required-message="This field can’t be blank" data-parsley-type-message="Please input numbers only">
                        </div>
                    </div>
                    <div class="b-f3-1"></div>
                    <div class="pure-control-group" style="margin-bottom:8px">
                        ...
                        <div class="input">
                            ...
                            <input name="max_session_per_day" type="text" class="pure-input-1-2 e-only" value="<?php echo(@$data->max_session_per_day); ?>" data-parsley-type="digits" required data-parsley-required-message="This field can’t be blank" data-parsley-type-message="Please input numbers only">
                        </div>
                    </div>
                    <div class="b-f3-1"></div>
                            ...
                            <div class="pure-g e-only">
                                <div class="pure-u-1 m-b-5">
                                    <label class="radio d-i-block m-b-15">
                                        <input type="radio" name="session_duration" value="15" <?php echo(@$data->session_duration == 15 ? 'checked="true"' : '');?>>
                                ...
                                <div class="pure-u-1">
                                    <label class="radio d-i-block m-b-15">
                                        <input type="radio" name="session_duration" value="25" <?php echo(@$data->session_duration == 25 ? 'checked="true"' : '');?>>
                                        <span class="outer m-r-10"><span class="inner"></span></span>
                                        25 Minutes
                                    </label>
                                </div>
