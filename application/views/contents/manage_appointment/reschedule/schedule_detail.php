...
<script type="text/javascript">
    document.getElementById("date").onchange = function() {
            if(this.value == 0){
                window.location.href="<?php echo base_url(); ?>index.php/student/manage_appointments";
            }
            else{
                window.location.href="<?php echo base_url(); ?>index.php/student/manage_appointments/reschedule_session/<?php echo ($appointment_id.'/'.$coach_id.'/')?>" + this.value;
            }
    };
</script>