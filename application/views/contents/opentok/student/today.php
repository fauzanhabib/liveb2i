                    ...
                    <tbody>
                        ...
                        foreach ($data as $d) {
                            ...
                            <tr>
								...
								<span class="text-cl-green"><?php echo(date('H:i',strtotime($d->start_time)));?> - <?php echo(date('H:i',strtotime($d->end_time)));?></span></td>
                                <td class="padding-10-15 md-none">
                                    <a href="<?php echo site_url('student/session/coach_detail/' . $d->coach_id); ?>" class="text-cl-secondary"><?php echo $d->fullname ?></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
